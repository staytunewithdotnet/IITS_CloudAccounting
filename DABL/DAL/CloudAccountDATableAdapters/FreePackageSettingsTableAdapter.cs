...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class FreePackageSettingsTableAdapter : Component
    {
        ...
        public FreePackageSettingsTableAdapter()
        {
        ...
        public virtual int Delete(int? FreePackageSettingID)
        {
            int num2;
            if (FreePackageSettingID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = FreePackageSettingID.Value;
            }
            else
            {
        ...
        public virtual int Fill(CloudAccountDA.FreePackageSettingsDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.FreePackageSettingsDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.FreePackageSettingsDataTable dataTable = new CloudAccountDA.FreePackageSettingsDataTable();
        ...
        public virtual CloudAccountDA.FreePackageSettingsDataTable GetDataByFreePackageSettingID(int? FreePackageSettingID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if (FreePackageSettingID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = FreePackageSettingID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "FreePackageSettings"
            };
            mapping.ColumnMappings.Add("FreePackageSettingID", "FreePackageSettingID");
            mapping.ColumnMappings.Add("FreePackageDays", "FreePackageDays");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_FreePackageSettings_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@FreePackageSettingID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FreePackageSettingID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_FreePackageSettings_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FreePackageSettingID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "FreePackageSettingID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FreePackageDays", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FreePackageDays", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_FreePackageSettings_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@FreePackageSettingID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FreePackageSettingID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@FreePackageDays", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FreePackageDays", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_FreePackageSettings_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_FreePackageSettings_SelectByFreePackageSettingID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@FreePackageSettingID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? FreePackageSettingID, int? FreePackageDays)
        {
            int num2;
            if (FreePackageSettingID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = FreePackageSettingID.Value;
            }
            else
            {
                this.Adapter.InsertCommand.Parameters[1].Value = DBNull.Value;
            }
            if (FreePackageDays.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[2].Value = FreePackageDays.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    FreePackageSettingID = 0;
                }
                else
                {
                    FreePackageSettingID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "FreePackageSettings");
        }
        
        [HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int Update(CloudAccountDA.FreePackageSettingsDataTable dataTable)
        {
        ...
        public virtual int Update(int? FreePackageSettingID, int? FreePackageDays)
        {
            int num2;
            if (FreePackageSettingID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = FreePackageSettingID.Value;
            }
            else
            {
            ...
            if (FreePackageDays.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = FreePackageDays.Value;
            }
            else
            {
