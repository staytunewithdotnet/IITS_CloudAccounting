...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class CurrentAccountMasterTableAdapter : Component
    {
        ...
        public CurrentAccountMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? CurrentAccountID)
        {
            int num2;
            if (CurrentAccountID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = CurrentAccountID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "CurrentAccountMaster"
            };
            mapping.ColumnMappings.Add("CurrentAccountID", "CurrentAccountID");
            mapping.ColumnMappings.Add("CurrentAccountName", "CurrentAccountName");
            mapping.ColumnMappings.Add("CurrentAccountDesc", "CurrentAccountDesc");
            mapping.ColumnMappings.Add("CurrentAccountStatus", "CurrentAccountStatus");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_CurrentAccountMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@CurrentAccountID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CurrentAccountID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_CurrentAccountMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CurrentAccountID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "CurrentAccountID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CurrentAccountName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "CurrentAccountName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CurrentAccountDesc", SqlDbType.NVarChar, 500, ParameterDirection.Input, 0, 0, "CurrentAccountDesc", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CurrentAccountStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "CurrentAccountStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_CurrentAccountMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CurrentAccountName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "CurrentAccountName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CurrentAccountDesc", SqlDbType.NVarChar, 500, ParameterDirection.Input, 0, 0, "CurrentAccountDesc", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CurrentAccountStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "CurrentAccountStatus", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_CurrentAccountMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_CurrentAccountMaster_SelectByCurrentAccountID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@CurrentAccountID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "dbo.PR_CurrentAccountMaster_SelectByCurrentAccountName";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@CurrentAccountName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? CurrentAccountID, string CurrentAccountName, string CurrentAccountDesc, bool? CurrentAccountStatus)
        {
            int num2;
            if (CurrentAccountID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = CurrentAccountID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = CurrentAccountName;
            }
            if (CurrentAccountDesc == null)
            {
                this.Adapter.InsertCommand.Parameters[3].Value = DBNull.Value;
            }
            else
            {
                this.Adapter.InsertCommand.Parameters[3].Value = CurrentAccountDesc;
            }
            if (CurrentAccountStatus.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[4].Value = CurrentAccountStatus.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    CurrentAccountID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "CurrentAccountMaster");
        }
        ...
        public virtual int Update(int? CurrentAccountID, string CurrentAccountName, string CurrentAccountDesc, bool? CurrentAccountStatus)
        {
            int num2;
            if (CurrentAccountID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = CurrentAccountID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = CurrentAccountName;
            }
            if (CurrentAccountDesc == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = CurrentAccountDesc;
            }
            if (CurrentAccountStatus.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = CurrentAccountStatus.Value;
            }
            else
            {
