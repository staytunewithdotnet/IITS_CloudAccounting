...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ModuleFormMasterTableAdapter : Component
    {
        ...
        public ModuleFormMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? ModuleFormID)
        {
            int num2;
            if (ModuleFormID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = ModuleFormID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.ModuleFormMasterDataTable DeleteByModuleID(int? ModuleID)
        {
            ...
            CloudAccountDA.ModuleFormMasterDataTable dataTable = new CloudAccountDA.ModuleFormMasterDataTable();
        ...
        public virtual int Fill(CloudAccountDA.ModuleFormMasterDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.ModuleFormMasterDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.ModuleFormMasterDataTable dataTable = new CloudAccountDA.ModuleFormMasterDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.ModuleFormMasterDataTable GetDataByFormID(int? FormID)
        {
        ...
        public virtual CloudAccountDA.ModuleFormMasterDataTable GetDataByModuleFormID(int? ModuleFormID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if (ModuleFormID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = ModuleFormID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        public virtual CloudAccountDA.ModuleFormMasterDataTable GetDataByModuleID(int? ModuleID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ModuleFormMaster"
            };
            mapping.ColumnMappings.Add("ModuleFormID", "ModuleFormID");
            ...
            mapping.ColumnMappings.Add("ModuleFormStatus", "ModuleFormStatus");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_ModuleFormMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@ModuleFormID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ModuleFormID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_ModuleFormMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ModuleFormID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "ModuleFormID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ModuleFormStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "ModuleFormStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_ModuleFormMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ModuleFormID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ModuleFormID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ModuleFormStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "ModuleFormStatus", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_ModuleFormMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_ModuleFormMaster_DeleteByModuleID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_ModuleFormMaster_SelectByFormID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@FormID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_ModuleFormMaster_SelectByModuleFormID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@ModuleFormID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "dbo.PR_ModuleFormMaster_SelectByModuleID";
            ...
            this._commandCollection[4].Parameters.Add(new SqlParameter("@ModuleID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? ModuleFormID, int? ModuleID, int? FormID, string ModuleFormName, bool? ModuleFormStatus)
        {
            int num2;
            if (ModuleFormID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = ModuleFormID.Value;
            }
            else
            {
            ...
            if (ModuleID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[2].Value = ModuleID.Value;
            }
            else
            {
            ...
            if (FormID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[3].Value = FormID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[4].Value = ModuleFormName;
            }
            if (ModuleFormStatus.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[5].Value = ModuleFormStatus.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    ModuleFormID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "ModuleFormMaster");
        }
        
        [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.ModuleFormMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? ModuleFormID, int? ModuleID, int? FormID, string ModuleFormName, bool? ModuleFormStatus)
        {
            int num2;
            if (ModuleFormID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = ModuleFormID.Value;
            }
            else
            {
            ...
            if (ModuleID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = ModuleID.Value;
            }
            else
            {
            ...
            if (FormID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = FormID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = ModuleFormName;
            }
            if (ModuleFormStatus.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = ModuleFormStatus.Value;
            }
            else
            {
