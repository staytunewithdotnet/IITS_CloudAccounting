...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class NewInvoiceEmailTemplateTableAdapter : Component
    {
        ...
        public NewInvoiceEmailTemplateTableAdapter()
        {
        ...
        public virtual int Delete(int? NewInvoiceEmailTemplateID)
        {
            int num2;
            if (NewInvoiceEmailTemplateID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = NewInvoiceEmailTemplateID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.NewInvoiceEmailTemplateDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.NewInvoiceEmailTemplateDataTable dataTable = new CloudAccountDA.NewInvoiceEmailTemplateDataTable();
        ...
        public virtual int Fill(CloudAccountDA.NewInvoiceEmailTemplateDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.NewInvoiceEmailTemplateDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.NewInvoiceEmailTemplateDataTable dataTable = new CloudAccountDA.NewInvoiceEmailTemplateDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.NewInvoiceEmailTemplateDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "NewInvoiceEmailTemplate"
            };
            mapping.ColumnMappings.Add("NewInvoiceEmailTemplateID", "NewInvoiceEmailTemplateID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_NewInvoiceEmailTemplate_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@NewInvoiceEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "NewInvoiceEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_NewInvoiceEmailTemplate_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@NewInvoiceEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "NewInvoiceEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_NewInvoiceEmailTemplate_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@NewInvoiceEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "NewInvoiceEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_NewInvoiceEmailTemplate_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_NewInvoiceEmailTemplate_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_NewInvoiceEmailTemplate_SelectByCompanyID";
        ...
        public virtual int Insert(ref int? NewInvoiceEmailTemplateID, int? CompanyID, string EmailSubject, string EmailBody)
        {
            int num2;
            if (NewInvoiceEmailTemplateID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = NewInvoiceEmailTemplateID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    NewInvoiceEmailTemplateID = 0;
                }
                else
                {
                    NewInvoiceEmailTemplateID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "NewInvoiceEmailTemplate");
        }
        
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.NewInvoiceEmailTemplateDataTable dataTable)
        {
        ...
        public virtual int Update(int? NewInvoiceEmailTemplateID, int? CompanyID, string EmailSubject, string EmailBody)
        {
            int num2;
            if (NewInvoiceEmailTemplateID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = NewInvoiceEmailTemplateID.Value;
            }
            else
            {
