...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class FooterContentTableAdapter : Component
    {
        ...
        public FooterContentTableAdapter()
        {
        ...
        public virtual int Delete(int? FooterContentID)
        {
            int num2;
            if (FooterContentID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = FooterContentID.Value;
            }
            else
            {
        ...
        public virtual int Fill(CloudAccountDA.FooterContentDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.FooterContentDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.FooterContentDataTable dataTable = new CloudAccountDA.FooterContentDataTable();
        ...
        public virtual CloudAccountDA.FooterContentDataTable GetDataByFooterID(int? FooterContentID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if (FooterContentID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = FooterContentID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "FooterContent"
            };
            mapping.ColumnMappings.Add("FooterContentID", "FooterContentID");
            mapping.ColumnMappings.Add("FooterContent", "FooterContent");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_FooterContent_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@FooterContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FooterContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_FooterContent_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FooterContentID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "FooterContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FooterContent", SqlDbType.NVarChar, 500, ParameterDirection.Input, 0, 0, "FooterContent", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_FooterContent_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@FooterContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FooterContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@FooterContent", SqlDbType.NVarChar, 500, ParameterDirection.Input, 0, 0, "FooterContent", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_FooterContent_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_FooterContent_SelectByFooterContentID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@FooterContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? FooterContentID, string FooterContent)
        {
            int num2;
            if (FooterContentID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = FooterContentID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = FooterContent;
            }
            ...
            try
            {
                ...
                {
                    FooterContentID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "FooterContent");
        }
        
        [DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter"), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int Update(CloudAccountDA.FooterContentDataTable dataTable)
        {
        ...
        public virtual int Update(int? FooterContentID, string FooterContent)
        {
            int num2;
            if (FooterContentID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = FooterContentID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = FooterContent;
            }
