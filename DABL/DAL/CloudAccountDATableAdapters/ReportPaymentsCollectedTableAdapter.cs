...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ReportPaymentsCollectedTableAdapter : Component
    {
        ...
        public ReportPaymentsCollectedTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.ReportPaymentsCollectedDataTable dataTable, int? CompanyID, int? ClientID, string PaymentMethod, DateTime? ToDate, DateTime? FromDate)
        {
            ...
            {
                this.Adapter.SelectCommand.Parameters[3].Value = PaymentMethod;
            }
            if (ToDate.HasValue)
            {
        ...
        public virtual CloudAccountDA.ReportPaymentsCollectedDataTable GetData(int? CompanyID, int? ClientID, string PaymentMethod, DateTime? ToDate, DateTime? FromDate)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.ReportPaymentsCollectedDataTable dataTable = new CloudAccountDA.ReportPaymentsCollectedDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ReportPaymentsCollected"
            };
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_PaymentsCollected";
            ...
            this._commandCollection[0].Parameters.Add(new SqlParameter("@PaymentMethod", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
