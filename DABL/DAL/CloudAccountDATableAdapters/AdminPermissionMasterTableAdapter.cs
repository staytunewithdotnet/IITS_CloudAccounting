...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class AdminPermissionMasterTableAdapter : Component
    {
        ...
        public AdminPermissionMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? AdminPermissionID)
        {
            int num2;
            if (AdminPermissionID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = AdminPermissionID.Value;
            }
            else
            {
        ...
        [DebuggerNonUserCode, DataObjectMethod(DataObjectMethodType.Select, false), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual CloudAccountDA.AdminPermissionMasterDataTable GetDataByAdminPermissionID(int? AdminPermissionID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if (AdminPermissionID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = AdminPermissionID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        public virtual CloudAccountDA.AdminPermissionMasterDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "AdminPermissionMaster"
            };
            mapping.ColumnMappings.Add("AdminPermissionID", "AdminPermissionID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_AdminPermissionMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@AdminPermissionID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AdminPermissionID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_AdminPermissionMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AdminPermissionID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "AdminPermissionID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_AdminPermissionMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@AdminPermissionID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AdminPermissionID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_AdminPermissionMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_AdminPermissionMaster_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_AdminPermissionMaster_SelectByAdminPermissionID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@AdminPermissionID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_AdminPermissionMaster_SelectByCompanyID";
        ...
        public virtual int Insert(ref int? AdminPermissionID, int? CompanyID, bool? Estimate, bool? Expenses, bool? TimeTracking, bool? Support, bool? Documents)
        {
            int num2;
            if (AdminPermissionID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = AdminPermissionID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = Estimate.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[4].Value = Expenses.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[5].Value = TimeTracking.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    AdminPermissionID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "AdminPermissionMaster");
        }
        ...
        public virtual int Update(int? AdminPermissionID, int? CompanyID, bool? Estimate, bool? Expenses, bool? TimeTracking, bool? Support, bool? Documents)
        {
            int num2;
            if (AdminPermissionID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = AdminPermissionID.Value;
            }
            else
            {
            ...
            if (Estimate.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = Estimate.Value;
            }
            else
            {
            ...
            if (Expenses.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = Expenses.Value;
            }
            else
            {
            ...
            if (TimeTracking.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = TimeTracking.Value;
            }
            else
            {
