...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class StaffProjectDetailTableAdapter : Component
    {
        ...
        public StaffProjectDetailTableAdapter()
        {
        ...
        public virtual int Delete(int? StaffProjectDetailID)
        {
            int num2;
            if (StaffProjectDetailID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = StaffProjectDetailID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.StaffProjectDetailDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.StaffProjectDetailDataTable dataTable = new CloudAccountDA.StaffProjectDetailDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        
        [HelpKeyword("vs.data.TableAdapter"), DataObjectMethod(DataObjectMethodType.Select, false), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode]
        public virtual CloudAccountDA.StaffProjectDetailDataTable DeleteByProjectID(int? ProjectID)
        {
        ...
        public virtual CloudAccountDA.StaffProjectDetailDataTable DeleteByStaffID(int? StaffID)
        {
        ...
        public virtual int Fill(CloudAccountDA.StaffProjectDetailDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.StaffProjectDetailDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.StaffProjectDetailDataTable dataTable = new CloudAccountDA.StaffProjectDetailDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.StaffProjectDetailDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        [DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter"), DataObjectMethod(DataObjectMethodType.Select, false), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual CloudAccountDA.StaffProjectDetailDataTable GetDataByProjectID(int? ProjectID)
        {
        ...
        public virtual CloudAccountDA.StaffProjectDetailDataTable GetDataByStaffID(int? StaffID)
        {
        ...
        public virtual CloudAccountDA.StaffProjectDetailDataTable GetDataByStaffProjectDetailID(int? StaffProjectDetailID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[7];
            if (StaffProjectDetailID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = StaffProjectDetailID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "StaffProjectDetail"
            };
            mapping.ColumnMappings.Add("StaffProjectDetailID", "StaffProjectDetailID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_StaffProjectDetail_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@StaffProjectDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "StaffProjectDetailID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_StaffProjectDetail_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@StaffProjectDetailID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "StaffProjectDetailID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_StaffProjectDetail_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@StaffProjectDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "StaffProjectDetailID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_StaffProjectDetail_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_StaffProjectDetail_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_StaffProjectDetail_DeleteByProjectID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@ProjectID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_StaffProjectDetail_DeleteByStaffID";
            ...
            this._commandCollection[4].CommandText = "dbo.PR_StaffProjectDetail_SelectByCompanyID";
            ...
            this._commandCollection[5].CommandText = "dbo.PR_StaffProjectDetail_SelectByProjectID";
            ...
            this._commandCollection[5].Parameters.Add(new SqlParameter("@ProjectID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6] = new SqlCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = "dbo.PR_StaffProjectDetail_SelectByStaffID";
            ...
            this._commandCollection[7].CommandText = "dbo.PR_StaffProjectDetail_SelectByStaffProjectDetailID";
            ...
            this._commandCollection[7].Parameters.Add(new SqlParameter("@StaffProjectDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? StaffProjectDetailID, int? CompanyID, int? StaffID, int? ProjectID)
        {
            int num2;
            if (StaffProjectDetailID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = StaffProjectDetailID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    StaffProjectDetailID = 0;
                }
                else
                {
                    StaffProjectDetailID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "StaffProjectDetail");
        }
        
        [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.StaffProjectDetailDataTable dataTable)
        {
        ...
        public virtual int Update(int? StaffProjectDetailID, int? CompanyID, int? StaffID, int? ProjectID)
        {
            int num2;
            if (StaffProjectDetailID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = StaffProjectDetailID.Value;
            }
            else
            {
