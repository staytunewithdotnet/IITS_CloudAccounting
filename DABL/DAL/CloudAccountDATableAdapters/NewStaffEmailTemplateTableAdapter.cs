...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class NewStaffEmailTemplateTableAdapter : Component
    {
        ...
        public NewStaffEmailTemplateTableAdapter()
        {
        ...
        public virtual int Delete(int? NewStaffEmailTemplateID)
        {
            int num2;
            if (NewStaffEmailTemplateID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = NewStaffEmailTemplateID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.NewStaffEmailTemplateDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.NewStaffEmailTemplateDataTable dataTable = new CloudAccountDA.NewStaffEmailTemplateDataTable();
        ...
        public virtual int Fill(CloudAccountDA.NewStaffEmailTemplateDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.NewStaffEmailTemplateDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.NewStaffEmailTemplateDataTable dataTable = new CloudAccountDA.NewStaffEmailTemplateDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.NewStaffEmailTemplateDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "NewStaffEmailTemplate"
            };
            mapping.ColumnMappings.Add("NewStaffEmailTemplateID", "NewStaffEmailTemplateID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_NewStaffEmailTemplate_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@NewStaffEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "NewStaffEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_NewStaffEmailTemplate_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@NewStaffEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "NewStaffEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_NewStaffEmailTemplate_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@NewStaffEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "NewStaffEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_NewStaffEmailTemplate_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_NewStaffEmailTemplate_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_NewStaffEmailTemplate_SelectByCompanyID";
        ...
        public virtual int Insert(ref int? NewStaffEmailTemplateID, int? CompanyID, string EmailSubject, string EmailBody)
        {
            int num2;
            if (NewStaffEmailTemplateID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = NewStaffEmailTemplateID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    NewStaffEmailTemplateID = 0;
                }
                else
                {
                    NewStaffEmailTemplateID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "NewStaffEmailTemplate");
        }
        
        [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.NewStaffEmailTemplateDataTable dataTable)
        {
        ...
        public virtual int Update(int? NewStaffEmailTemplateID, int? CompanyID, string EmailSubject, string EmailBody)
        {
            int num2;
            if (NewStaffEmailTemplateID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = NewStaffEmailTemplateID.Value;
            }
            else
            {
