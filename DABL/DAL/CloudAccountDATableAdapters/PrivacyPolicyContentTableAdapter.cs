...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class PrivacyPolicyContentTableAdapter : Component
    {
        ...
        public PrivacyPolicyContentTableAdapter()
        {
        ...
        public virtual int Delete(int? PrivacyPolicyContentID)
        {
            int num2;
            if (PrivacyPolicyContentID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = PrivacyPolicyContentID.Value;
            }
            else
            {
        ...
        public virtual int Fill(CloudAccountDA.PrivacyPolicyContentDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.PrivacyPolicyContentDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.PrivacyPolicyContentDataTable dataTable = new CloudAccountDA.PrivacyPolicyContentDataTable();
        ...
        public virtual CloudAccountDA.PrivacyPolicyContentDataTable GetDataByPrivacyPolicyContentID(int? PrivacyPolicyContentID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if (PrivacyPolicyContentID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = PrivacyPolicyContentID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "PrivacyPolicyContent"
            };
            mapping.ColumnMappings.Add("PrivacyPolicyContentID", "PrivacyPolicyContentID");
            mapping.ColumnMappings.Add("PrivacyPolicyContent", "PrivacyPolicyContent");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_PrivacyPolicyContent_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@PrivacyPolicyContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "PrivacyPolicyContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_PrivacyPolicyContent_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PrivacyPolicyContentID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "PrivacyPolicyContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PrivacyPolicyContent", SqlDbType.NVarChar, 0x7fffffff, ParameterDirection.Input, 0, 0, "PrivacyPolicyContent", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_PrivacyPolicyContent_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PrivacyPolicyContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "PrivacyPolicyContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PrivacyPolicyContent", SqlDbType.NVarChar, 0x7fffffff, ParameterDirection.Input, 0, 0, "PrivacyPolicyContent", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_PrivacyPolicyContent_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_PrivacyPolicyContent_SelectByPrivacyPolicyContentID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@PrivacyPolicyContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? PrivacyPolicyContentID, string PrivacyPolicyContent)
        {
            int num2;
            if (PrivacyPolicyContentID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = PrivacyPolicyContentID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = PrivacyPolicyContent;
            }
            ...
            try
            {
                ...
                {
                    PrivacyPolicyContentID = 0;
                }
                else
                {
                    PrivacyPolicyContentID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "PrivacyPolicyContent");
        }
        
        [HelpKeyword("vs.data.TableAdapter"), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode]
        public virtual int Update(CloudAccountDA.PrivacyPolicyContentDataTable dataTable)
        {
        ...
        public virtual int Update(int? PrivacyPolicyContentID, string PrivacyPolicyContent)
        {
            int num2;
            if (PrivacyPolicyContentID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = PrivacyPolicyContentID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = PrivacyPolicyContent;
            }
