...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class PackageDetailsTableAdapter : Component
    {
        ...
        public PackageDetailsTableAdapter()
        {
        ...
        public virtual int Delete(int? PackageDetailID)
        {
            int num2;
            if (PackageDetailID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = PackageDetailID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.PackageDetailsDataTable DeleteByPackageID(int? PackageID)
        {
            ...
            CloudAccountDA.PackageDetailsDataTable dataTable = new CloudAccountDA.PackageDetailsDataTable();
        ...
        public virtual int Fill(CloudAccountDA.PackageDetailsDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.PackageDetailsDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.PackageDetailsDataTable dataTable = new CloudAccountDA.PackageDetailsDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.PackageDetailsDataTable GetDataByModuleID(int? ModuleID)
        {
        ...
        public virtual CloudAccountDA.PackageDetailsDataTable GetDataByPackageDetailID(int? PackageDetailID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if (PackageDetailID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = PackageDetailID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        public virtual CloudAccountDA.PackageDetailsDataTable GetDataByPackageID(int? PackageID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "PackageDetails"
            };
            mapping.ColumnMappings.Add("PackageDetailID", "PackageDetailID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_PackageDetails_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@PackageDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "PackageDetailID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_PackageDetails_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PackageDetailID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "PackageDetailID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_PackageDetails_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PackageDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "PackageDetailID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_PackageDetails_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_PackageDetails_DeleteByPackageID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_PackageDetails_SelectByModuleID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@ModuleID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_PackageDetails_SelectByPackageDetailID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@PackageDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "dbo.PR_PackageDetails_SelectByPackageID";
        ...
        public virtual int Insert(ref int? PackageDetailID, int? PackageID, int? ModuleID, bool? ModuleStatus)
        {
            int num2;
            if (PackageDetailID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = PackageDetailID.Value;
            }
            else
            {
            ...
            if (PackageID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[2].Value = PackageID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    PackageDetailID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "PackageDetails");
        }
        
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.PackageDetailsDataTable dataTable)
        {
        ...
        public virtual int Update(int? PackageDetailID, int? PackageID, int? ModuleID, bool? ModuleStatus)
        {
            int num2;
            if (PackageDetailID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = PackageDetailID.Value;
            }
            else
            {
            ...
            if (PackageID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = PackageID.Value;
            }
            else
            {
