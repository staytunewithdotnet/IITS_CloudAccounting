...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    [ToolboxItem(true), Designer("Microsoft.VSDesigner.DataSource.Design.TableAdapterDesigner, Microsoft.VSDesigner, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DesignerCategory("code"), DataObject(true), HelpKeyword("vs.data.TableAdapter")]
    public class ReportInvoiceDetailsTableAdapter : Component
    {
        ...
        public ReportInvoiceDetailsTableAdapter()
        {
        ...
        public virtual CloudAccountDA.ReportInvoiceDetailsDataTable GetData(int? CompanyID, int? ClientID, string Status, DateTime? FromDate, DateTime? ToDate)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.ReportInvoiceDetailsDataTable dataTable = new CloudAccountDA.ReportInvoiceDetailsDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ReportInvoiceDetails"
            };
            ...
            mapping.ColumnMappings.Add("Item", "Item");
            mapping.ColumnMappings.Add("Unit Cost", "Unit Cost");
            mapping.ColumnMappings.Add("Quantity", "Quantity");
            mapping.ColumnMappings.Add("Tax 1", "Tax 1");
            mapping.ColumnMappings.Add("Tax 2", "Tax 2");
            mapping.ColumnMappings.Add("Amount", "Amount");
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_InvoiceDetails";
