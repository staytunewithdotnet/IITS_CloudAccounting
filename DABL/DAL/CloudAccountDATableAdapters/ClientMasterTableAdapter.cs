...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ClientMasterTableAdapter : Component
    {
        ...
        public virtual int Delete(int? ClientID)
        {
            int num2;
            if (ClientID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = ClientID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ClientMaster"
            };
            mapping.ColumnMappings.Add("ClientID", "ClientID");
            mapping.ColumnMappings.Add("ClientName", "ClientName");
            mapping.ColumnMappings.Add("ClientURL", "ClientURL");
            mapping.ColumnMappings.Add("ClientStatus", "ClientStatus");
            mapping.ColumnMappings.Add("ClientLogo", "ClientLogo");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_ClientMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@ClientID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ClientID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_ClientMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ClientID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "ClientID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ClientName", SqlDbType.NVarChar, 150, ParameterDirection.Input, 0, 0, "ClientName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ClientURL", SqlDbType.NVarChar, 150, ParameterDirection.Input, 0, 0, "ClientURL", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ClientStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "ClientStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ClientLogo", SqlDbType.Image, 0x7fffffff, ParameterDirection.Input, 0, 0, "ClientLogo", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_ClientMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ClientName", SqlDbType.NVarChar, 150, ParameterDirection.Input, 0, 0, "ClientName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ClientURL", SqlDbType.NVarChar, 150, ParameterDirection.Input, 0, 0, "ClientURL", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ClientStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "ClientStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ClientLogo", SqlDbType.Image, 0x7fffffff, ParameterDirection.Input, 0, 0, "ClientLogo", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_ClientMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_ClientMaster_SelectByClientID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_ClientMaster_SelectByClientName";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@ClientName", SqlDbType.NVarChar, 150, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? ClientID, string ClientName, string ClientURL, bool? ClientStatus, byte[] ClientLogo)
        {
            int num2;
            if (ClientID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = ClientID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = ClientName;
            }
            if (ClientURL == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = ClientURL;
            }
            if (ClientStatus.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[4].Value = ClientStatus.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[5].Value = ClientLogo;
            }
            ...
            try
            {
                ...
                {
                    ClientID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "ClientMaster");
        }
        ...
        public virtual int Update(int? ClientID, string ClientName, string ClientURL, bool? ClientStatus, byte[] ClientLogo)
        {
            int num2;
            if (ClientID.HasValue)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = ClientName;
            }
            if (ClientURL == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = ClientURL;
            }
            if (ClientStatus.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = ClientStatus.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = ClientLogo;
            }
