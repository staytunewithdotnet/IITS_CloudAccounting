...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class AutoBillEmailTemplateTableAdapter : Component
    {
        ...
        public AutoBillEmailTemplateTableAdapter()
        {
        ...
        public virtual int Delete(int? AutoBillEmailTemplateID)
        {
            int num2;
            if (AutoBillEmailTemplateID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = AutoBillEmailTemplateID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.AutoBillEmailTemplateDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.AutoBillEmailTemplateDataTable dataTable = new CloudAccountDA.AutoBillEmailTemplateDataTable();
        ...
        public virtual int Fill(CloudAccountDA.AutoBillEmailTemplateDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.AutoBillEmailTemplateDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.AutoBillEmailTemplateDataTable dataTable = new CloudAccountDA.AutoBillEmailTemplateDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.AutoBillEmailTemplateDataTable GetDataByCompanyID(int? CompanyID, string TemplateFor)
        {
            ...
            {
                this.Adapter.SelectCommand.Parameters[2].Value = TemplateFor;
            }
            CloudAccountDA.AutoBillEmailTemplateDataTable dataTable = new CloudAccountDA.AutoBillEmailTemplateDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "AutoBillEmailTemplate"
            };
            mapping.ColumnMappings.Add("AutoBillEmailTemplateID", "AutoBillEmailTemplateID");
            mapping.ColumnMappings.Add("CompanyID", "CompanyID");
            mapping.ColumnMappings.Add("TemplateFor", "TemplateFor");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_AutoBillEmailTemplate_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@AutoBillEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AutoBillEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_AutoBillEmailTemplate_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AutoBillEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "AutoBillEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TemplateFor", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "TemplateFor", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_AutoBillEmailTemplate_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@AutoBillEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AutoBillEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TemplateFor", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "TemplateFor", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_AutoBillEmailTemplate_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_AutoBillEmailTemplate_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_AutoBillEmailTemplate_SelectByCompanyID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@TemplateFor", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? AutoBillEmailTemplateID, int? CompanyID, string TemplateFor, bool? Enable, string EmailSubject, string EmailBody)
        {
            int num2;
            if (AutoBillEmailTemplateID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = AutoBillEmailTemplateID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = TemplateFor;
            }
            if (Enable.HasValue)
            {
            ...
            try
            {
                ...
                {
                    AutoBillEmailTemplateID = 0;
                }
                else
                {
                    AutoBillEmailTemplateID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "AutoBillEmailTemplate");
        }
        
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.AutoBillEmailTemplateDataTable dataTable)
        {
        ...
        public virtual int Update(int? AutoBillEmailTemplateID, int? CompanyID, string TemplateFor, bool? Enable, string EmailSubject, string EmailBody)
        {
            int num2;
            if (AutoBillEmailTemplateID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = AutoBillEmailTemplateID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = TemplateFor;
            }
            if (Enable.HasValue)
            {
