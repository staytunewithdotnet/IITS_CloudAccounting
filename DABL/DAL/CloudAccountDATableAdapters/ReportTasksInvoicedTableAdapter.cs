...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ReportTasksInvoicedTableAdapter : Component
    {
        ...
        public ReportTasksInvoicedTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.ReportTasksInvoicedDataTable dataTable, int? TaskID, string Status, DateTime? FromDate, DateTime? ToDate)
        {
        ...
        public virtual CloudAccountDA.ReportTasksInvoicedDataTable GetData(int? TaskID, string Status, DateTime? FromDate, DateTime? ToDate)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (TaskID.HasValue)
            {
            ...
            CloudAccountDA.ReportTasksInvoicedDataTable dataTable = new CloudAccountDA.ReportTasksInvoicedDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ReportTasksInvoiced"
            };
            mapping.ColumnMappings.Add("Client Name", "Client Name");
            mapping.ColumnMappings.Add("Invoice", "Invoice");
            mapping.ColumnMappings.Add("Invoice Date", "Invoice Date");
            mapping.ColumnMappings.Add("Rate", "Rate");
            mapping.ColumnMappings.Add("Hours", "Hours");
            mapping.ColumnMappings.Add("Discount Amount", "Discount Amount");
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_TasksInvoiced";
            ...
            this._commandCollection[0].Parameters.Add(new SqlParameter("@Status", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
