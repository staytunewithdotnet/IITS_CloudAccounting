...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class FormMasterTableAdapter : Component
    {
        ...
        public virtual int Delete(int? FormID)
        {
            int num2;
            if (FormID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = FormID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "FormMaster"
            };
            mapping.ColumnMappings.Add("FormID", "FormID");
            mapping.ColumnMappings.Add("FormName", "FormName");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_FormMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@FormID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "FormID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_FormMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FormID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "FormID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FormName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "FormName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_FormMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@FormName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "FormName", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_FormMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_FormMaster_SelectByFormID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@FormID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "dbo.PR_FormMaster_SelectByFormName";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@FormName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? FormID, string FormName)
        {
            int num2;
            if (FormID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = FormID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = FormName;
            }
            ...
            try
            {
                ...
                {
                    FormID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "FormMaster");
        }
        ...
        public virtual int Update(int? FormID, string FormName)
        {
            int num2;
            if (FormID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = FormID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = FormName;
            }
