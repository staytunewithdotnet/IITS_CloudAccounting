...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    [DesignerCategory("code"), HelpKeyword("vs.data.TableAdapter"), DataObject(true), Designer("Microsoft.VSDesigner.DataSource.Design.TableAdapterDesigner, Microsoft.VSDesigner, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ToolboxItem(true)]
    public class EstimateDefaultTermsMasterTableAdapter : Component
    {
        ...
        public EstimateDefaultTermsMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? EstimateDefaultTermsID)
        {
            int num2;
            if (EstimateDefaultTermsID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = EstimateDefaultTermsID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.EstimateDefaultTermsMasterDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.EstimateDefaultTermsMasterDataTable dataTable = new CloudAccountDA.EstimateDefaultTermsMasterDataTable();
        ...
        public virtual int Fill(CloudAccountDA.EstimateDefaultTermsMasterDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.EstimateDefaultTermsMasterDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.EstimateDefaultTermsMasterDataTable dataTable = new CloudAccountDA.EstimateDefaultTermsMasterDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.EstimateDefaultTermsMasterDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.EstimateDefaultTermsMasterDataTable GetDataByEstimateDefaultTermsID(int? EstimateDefaultTermsID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if (EstimateDefaultTermsID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = EstimateDefaultTermsID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "EstimateDefaultTermsMaster"
            };
            mapping.ColumnMappings.Add("EstimateDefaultTermsID", "EstimateDefaultTermsID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_EstimateDefaultTermsMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@EstimateDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "EstimateDefaultTermsID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_EstimateDefaultTermsMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@EstimateDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "EstimateDefaultTermsID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_EstimateDefaultTermsMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@EstimateDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "EstimateDefaultTermsID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_EstimateDefaultTermsMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_EstimateDefaultTermsMaster_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_EstimateDefaultTermsMaster_SelectByCompanyID";
            ...
            this._commandCollection[3].CommandText = "dbo.PR_EstimateDefaultTermsMaster_SelectByEstimateDefaultTermsID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@EstimateDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? EstimateDefaultTermsID, int? CompanyID, string DefaultTerms)
        {
            int num2;
            if (EstimateDefaultTermsID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = EstimateDefaultTermsID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    EstimateDefaultTermsID = 0;
                }
                else
                {
                    EstimateDefaultTermsID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "EstimateDefaultTermsMaster");
        }
        
        [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.EstimateDefaultTermsMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? EstimateDefaultTermsID, int? CompanyID, string DefaultTerms)
        {
            int num2;
            if (EstimateDefaultTermsID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = EstimateDefaultTermsID.Value;
            }
            else
            {
