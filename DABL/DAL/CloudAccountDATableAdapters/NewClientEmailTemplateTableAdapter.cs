...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class NewClientEmailTemplateTableAdapter : Component
    {
        ...
        public NewClientEmailTemplateTableAdapter()
        {
        ...
        public virtual int Delete(int? NewClientEmailTemplateID)
        {
            int num2;
            if (NewClientEmailTemplateID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = NewClientEmailTemplateID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.NewClientEmailTemplateDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.NewClientEmailTemplateDataTable dataTable = new CloudAccountDA.NewClientEmailTemplateDataTable();
        ...
        public virtual int Fill(CloudAccountDA.NewClientEmailTemplateDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.NewClientEmailTemplateDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.NewClientEmailTemplateDataTable dataTable = new CloudAccountDA.NewClientEmailTemplateDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode]
        public virtual CloudAccountDA.NewClientEmailTemplateDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "NewClientEmailTemplate"
            };
            mapping.ColumnMappings.Add("NewClientEmailTemplateID", "NewClientEmailTemplateID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_NewClientEmailTemplate_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@NewClientEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "NewClientEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_NewClientEmailTemplate_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@NewClientEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "NewClientEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_NewClientEmailTemplate_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@NewClientEmailTemplateID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "NewClientEmailTemplateID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_NewClientEmailTemplate_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_NewClientEmailTemplate_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_NewClientEmailTemplate_SelectByCompanyID";
        ...
        public virtual int Insert(ref int? NewClientEmailTemplateID, int? CompanyID, string EmailSubject, string EmailBody)
        {
            int num2;
            if (NewClientEmailTemplateID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = NewClientEmailTemplateID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    NewClientEmailTemplateID = 0;
                }
                else
                {
                    NewClientEmailTemplateID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "NewClientEmailTemplate");
        }
        
        [HelpKeyword("vs.data.TableAdapter"), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode]
        public virtual int Update(CloudAccountDA.NewClientEmailTemplateDataTable dataTable)
        {
        ...
        public virtual int Update(int? NewClientEmailTemplateID, int? CompanyID, string EmailSubject, string EmailBody)
        {
            int num2;
            if (NewClientEmailTemplateID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = NewClientEmailTemplateID.Value;
            }
            else
            {
