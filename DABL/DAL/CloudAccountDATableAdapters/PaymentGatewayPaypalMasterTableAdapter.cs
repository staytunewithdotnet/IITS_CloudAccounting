...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class PaymentGatewayPaypalMasterTableAdapter : Component
    {
        ...
        public PaymentGatewayPaypalMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? PaymentGatewayPaypalID)
        {
            int num2;
            if (PaymentGatewayPaypalID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = PaymentGatewayPaypalID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "PaymentGatewayPaypalMaster"
            };
            mapping.ColumnMappings.Add("PaymentGatewayPaypalID", "PaymentGatewayPaypalID");
            mapping.ColumnMappings.Add("PaypalID", "PaypalID");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_PaymentGatewayPaypalMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@PaymentGatewayPaypalID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "PaymentGatewayPaypalID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_PaymentGatewayPaypalMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PaymentGatewayPaypalID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "PaymentGatewayPaypalID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PaypalID", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "PaypalID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_PaymentGatewayPaypalMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PaymentGatewayPaypalID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "PaymentGatewayPaypalID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PaypalID", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "PaypalID", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_PaymentGatewayPaypalMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_PaymentGatewayPaypalMaster_SelectByPaymentGatewayPaypalID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@PaymentGatewayPaypalID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? PaymentGatewayPaypalID, string PaypalID)
        {
            int num2;
            if (PaymentGatewayPaypalID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = PaymentGatewayPaypalID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = PaypalID;
            }
            ...
            try
            {
                ...
                {
                    PaymentGatewayPaypalID = 0;
                }
                else
                {
                    PaymentGatewayPaypalID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "PaymentGatewayPaypalMaster");
        }
        ...
        public virtual int Update(int? PaymentGatewayPaypalID, string PaypalID)
        {
            int num2;
            if (PaymentGatewayPaypalID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = PaymentGatewayPaypalID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = PaypalID;
            }
