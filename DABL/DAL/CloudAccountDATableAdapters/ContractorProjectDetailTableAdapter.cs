...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ContractorProjectDetailTableAdapter : Component
    {
        ...
        public ContractorProjectDetailTableAdapter()
        {
        ...
        public virtual int Delete(int? ContractorProjectDetailID)
        {
            int num2;
            if (ContractorProjectDetailID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = ContractorProjectDetailID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.ContractorProjectDetailDataTable DeleteByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.ContractorProjectDetailDataTable DeleteByContractorID(int? ContractorID)
        {
        ...
        public virtual CloudAccountDA.ContractorProjectDetailDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        [DebuggerNonUserCode, DataObjectMethod(DataObjectMethodType.Select, false), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual CloudAccountDA.ContractorProjectDetailDataTable GetDataByContractorID(int? ContractorID)
        {
        ...
        public virtual CloudAccountDA.ContractorProjectDetailDataTable GetDataByContractorProjectDetailID(int? ContractorProjectDetailID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[6];
            if (ContractorProjectDetailID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = ContractorProjectDetailID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DataObjectMethod(DataObjectMethodType.Select, false)]
        public virtual CloudAccountDA.ContractorProjectDetailDataTable GetDataByProjectID(int? ProjectID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ContractorProjectDetail"
            };
            mapping.ColumnMappings.Add("ContractorProjectDetailID", "ContractorProjectDetailID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_ContractorProjectDetail_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@ContractorProjectDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ContractorProjectDetailID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_ContractorProjectDetail_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ContractorProjectDetailID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "ContractorProjectDetailID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ContractorID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ContractorID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_ContractorProjectDetail_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ContractorProjectDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ContractorProjectDetailID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_ContractorProjectDetail_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_ContractorProjectDetail_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_ContractorProjectDetail_DeleteByContractorID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@ContractorID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_ContractorProjectDetail_DeleteByProjectID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@ProjectID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "dbo.PR_ContractorProjectDetail_SelectByCompanyID";
            ...
            this._commandCollection[5].CommandText = "dbo.PR_ContractorProjectDetail_SelectByContractorID";
            ...
            this._commandCollection[6].CommandText = "dbo.PR_ContractorProjectDetail_SelectByContractorProjectDetailID";
            ...
            this._commandCollection[6].Parameters.Add(new SqlParameter("@ContractorProjectDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7] = new SqlCommand();
            this._commandCollection[7].Connection = this.Connection;
            this._commandCollection[7].CommandText = "dbo.PR_ContractorProjectDetail_SelectByProjectID";
        ...
        public virtual int Insert(ref int? ContractorProjectDetailID, int? CompanyID, int? ContractorID, int? ProjectID)
        {
            int num2;
            if (ContractorProjectDetailID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = ContractorProjectDetailID.Value;
            }
            else
            {
            ...
            if (ContractorID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[3].Value = ContractorID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    ContractorProjectDetailID = 0;
                }
                else
                {
                    ContractorProjectDetailID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "ContractorProjectDetail");
        }
        ...
        public virtual int Update(int? ContractorProjectDetailID, int? CompanyID, int? ContractorID, int? ProjectID)
        {
            int num2;
            if (ContractorProjectDetailID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = ContractorProjectDetailID.Value;
            }
            else
            {
            ...
            if (ContractorID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = ContractorID.Value;
            }
            else
            {
