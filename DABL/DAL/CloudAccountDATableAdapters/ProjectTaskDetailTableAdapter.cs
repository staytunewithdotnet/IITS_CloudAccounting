...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ProjectTaskDetailTableAdapter : Component
    {
        ...
        public ProjectTaskDetailTableAdapter()
        {
        ...
        public virtual int Delete(int? ProjectTaskID)
        {
            int num2;
            if (ProjectTaskID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = ProjectTaskID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.ProjectTaskDetailDataTable dataTable = new CloudAccountDA.ProjectTaskDetailDataTable();
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable DeleteByProjectID(int? ProjectID)
        {
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable DeleteByTaskID(int? TaskID)
        {
        ...
        public virtual int Fill(CloudAccountDA.ProjectTaskDetailDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.ProjectTaskDetailDataTable dataTable = new CloudAccountDA.ProjectTaskDetailDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DataObjectMethod(DataObjectMethodType.Select, false)]
        public virtual CloudAccountDA.ProjectTaskDetailDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable GetDataByProjectID(int? ProjectID)
        {
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable GetDataByProjectTaskID(int? ProjectTaskID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[6];
            if (ProjectTaskID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = ProjectTaskID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        public virtual CloudAccountDA.ProjectTaskDetailDataTable GetDataByTaskID(int? TaskID)
        {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ProjectTaskDetail"
            };
            mapping.ColumnMappings.Add("ProjectTaskID", "ProjectTaskID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_ProjectTaskDetails_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@ProjectTaskID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ProjectTaskID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_ProjectTaskDetails_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ProjectTaskID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "ProjectTaskID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_ProjectTaskDetails_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ProjectTaskID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "ProjectTaskID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_ProjectTaskDetails_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_ProjectTaskDetails_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_ProjectTaskDetails_DeleteByProjectID";
            ...
            this._commandCollection[3].CommandText = "dbo.PR_ProjectTaskDetails_DeleteByTaskID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@TaskID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "dbo.PR_ProjectTaskDetails_SelectByCompanyID";
            ...
            this._commandCollection[5].CommandText = "dbo.PR_ProjectTaskDetails_SelectByProjectID";
            ...
            this._commandCollection[6].CommandText = "dbo.PR_ProjectTaskDetails_SelectByProjectTaskID";
            ...
            this._commandCollection[6].Parameters.Add(new SqlParameter("@ProjectTaskID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7] = new SqlCommand();
            this._commandCollection[7].Connection = this.Connection;
            this._commandCollection[7].CommandText = "dbo.PR_ProjectTaskDetails_SelectByTaskID";
        ...
        public virtual int Insert(ref int? ProjectTaskID, int? CompanyID, int? ProjectID, int? TaskID)
        {
            int num2;
            if (ProjectTaskID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = ProjectTaskID.Value;
            }
            else
            {
            ...
            if (ProjectID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[3].Value = ProjectID.Value;
            }
            else
            {
            ...
            if (TaskID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[4].Value = TaskID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    ProjectTaskID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "ProjectTaskDetail");
        }
        
        [HelpKeyword("vs.data.TableAdapter"), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode]
        public virtual int Update(CloudAccountDA.ProjectTaskDetailDataTable dataTable)
        {
        ...
        public virtual int Update(int? ProjectTaskID, int? CompanyID, int? ProjectID, int? TaskID)
        {
            int num2;
            if (ProjectTaskID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = ProjectTaskID.Value;
            }
            else
            {
            ...
            if (ProjectID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = ProjectID.Value;
            }
            else
            {
            ...
            if (TaskID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = TaskID.Value;
            }
            else
            {
