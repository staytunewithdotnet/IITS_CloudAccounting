...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ReportTimesheetDetailsClientTableAdapter : Component
    {
        ...
        public ReportTimesheetDetailsClientTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.ReportTimesheetDetailsClientDataTable dataTable, int? CompanyID, int? ClientID, int? ProjectID, bool? Billed, DateTime? FromDate, DateTime? ToDate)
        {
        ...
        public virtual CloudAccountDA.ReportTimesheetDetailsClientDataTable GetData(int? CompanyID, int? ClientID, int? ProjectID, bool? Billed, DateTime? FromDate, DateTime? ToDate)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.ReportTimesheetDetailsClientDataTable dataTable = new CloudAccountDA.ReportTimesheetDetailsClientDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ReportTimesheetDetailsClient"
            };
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_TimesheetDetailsClient";
