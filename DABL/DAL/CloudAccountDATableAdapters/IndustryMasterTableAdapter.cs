...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class IndustryMasterTableAdapter : Component
    {
        ...
        public IndustryMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? IndustryID)
        {
            int num2;
            if (IndustryID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = IndustryID.Value;
            }
            else
            {
        ...
        public virtual int Fill(CloudAccountDA.IndustryMasterDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.IndustryMasterDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.IndustryMasterDataTable dataTable = new CloudAccountDA.IndustryMasterDataTable();
        ...
        public virtual CloudAccountDA.IndustryMasterDataTable GetDataByIndustryID(int? IndustryID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if (IndustryID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = IndustryID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.IndustryMasterDataTable GetDataByIndustryName(string IndustryName)
        {
            ...
            {
                this.Adapter.SelectCommand.Parameters[1].Value = IndustryName;
            }
            CloudAccountDA.IndustryMasterDataTable dataTable = new CloudAccountDA.IndustryMasterDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "IndustryMaster"
            };
            mapping.ColumnMappings.Add("IndustryID", "IndustryID");
            mapping.ColumnMappings.Add("IndustryName", "IndustryName");
            mapping.ColumnMappings.Add("IndustryDesc", "IndustryDesc");
            mapping.ColumnMappings.Add("IndustryStatus", "IndustryStatus");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_IndustryMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IndustryID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "IndustryID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_IndustryMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IndustryID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "IndustryID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IndustryName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "IndustryName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IndustryDesc", SqlDbType.NVarChar, 500, ParameterDirection.Input, 0, 0, "IndustryDesc", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IndustryStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "IndustryStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_IndustryMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IndustryName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "IndustryName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IndustryDesc", SqlDbType.NVarChar, 500, ParameterDirection.Input, 0, 0, "IndustryDesc", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IndustryStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "IndustryStatus", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_IndustryMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_IndustryMaster_SelectByIndustryID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@IndustryID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "dbo.PR_IndustryMaster_SelectByIndustryName";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@IndustryName", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? IndustryID, string IndustryName, string IndustryDesc, bool? IndustryStatus)
        {
            int num2;
            if (IndustryID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = IndustryID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = IndustryName;
            }
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = IndustryDesc;
            }
            if (IndustryStatus.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[4].Value = IndustryStatus.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    IndustryID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "IndustryMaster");
        }
        
        [HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int Update(CloudAccountDA.IndustryMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? IndustryID, string IndustryName, string IndustryDesc, bool? IndustryStatus)
        {
            int num2;
            if (IndustryID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = IndustryID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = IndustryName;
            }
            if (IndustryDesc == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = IndustryDesc;
            }
            if (IndustryStatus.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = IndustryStatus.Value;
            }
            else
            {
