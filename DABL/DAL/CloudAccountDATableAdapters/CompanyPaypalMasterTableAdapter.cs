...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    [DataObject(true), ToolboxItem(true), Designer("Microsoft.VSDesigner.DataSource.Design.TableAdapterDesigner, Microsoft.VSDesigner, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DesignerCategory("code"), HelpKeyword("vs.data.TableAdapter")]
    public class CompanyPaypalMasterTableAdapter : Component
    {
        ...
        public CompanyPaypalMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? CompanyPaypalID)
        {
            int num2;
            if (CompanyPaypalID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = CompanyPaypalID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.CompanyPaypalMasterDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.CompanyPaypalMasterDataTable dataTable = new CloudAccountDA.CompanyPaypalMasterDataTable();
        ...
        public virtual int Fill(CloudAccountDA.CompanyPaypalMasterDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.CompanyPaypalMasterDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.CompanyPaypalMasterDataTable dataTable = new CloudAccountDA.CompanyPaypalMasterDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.CompanyPaypalMasterDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.CompanyPaypalMasterDataTable GetDataByCompanyPaypalID(int? CompanyPaypalID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if (CompanyPaypalID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = CompanyPaypalID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "CompanyPaypalMaster"
            };
            mapping.ColumnMappings.Add("CompanyPaypalID", "CompanyPaypalID");
            mapping.ColumnMappings.Add("CompanyID", "CompanyID");
            mapping.ColumnMappings.Add("PaypalID", "PaypalID");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_CompanyPaypalMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@CompanyPaypalID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CompanyPaypalID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_CompanyPaypalMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CompanyPaypalID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "CompanyPaypalID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PaypalID", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "PaypalID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_CompanyPaypalMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CompanyPaypalID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CompanyPaypalID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PaypalID", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "PaypalID", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_CompanyPaypalMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_CompanyPaypalMaster_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_CompanyPaypalMaster_SelectByCompanyID";
            ...
            this._commandCollection[3].CommandText = "dbo.PR_CompanyPaypalMaster_SelectByCompanyPaypalID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@CompanyPaypalID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? CompanyPaypalID, int? CompanyID, string PaypalID)
        {
            int num2;
            if (CompanyPaypalID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = CompanyPaypalID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = PaypalID;
            }
            ...
            try
            {
                ...
                {
                    CompanyPaypalID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "CompanyPaypalMaster");
        }
        
        [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.CompanyPaypalMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? CompanyPaypalID, int? CompanyID, string PaypalID)
        {
            int num2;
            if (CompanyPaypalID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = CompanyPaypalID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = PaypalID;
            }
