...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class FormGridCompanyAdminMasterTableAdapter : Component
    {
        ...
        public FormGridCompanyAdminMasterTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.FormGridCompanyAdminMasterDataTable dataTable, int? ModuleID)
        {
        ...
        public virtual CloudAccountDA.FormGridCompanyAdminMasterDataTable GetData(int? ModuleID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (ModuleID.HasValue)
            {
            ...
            CloudAccountDA.FormGridCompanyAdminMasterDataTable dataTable = new CloudAccountDA.FormGridCompanyAdminMasterDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "FormGridCompanyAdminMaster"
            };
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_FormGridCompanyAdminMaster_SelectAll";
            ...
            this._commandCollection[0].Parameters.Add(new SqlParameter("@ModuleID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
