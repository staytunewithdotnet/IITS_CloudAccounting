...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class MasterAdminLoginMasterTableAdapter : Component
    {
        ...
        public MasterAdminLoginMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? MasterAdminUserID)
        {
            int num2;
            if (MasterAdminUserID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = MasterAdminUserID.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "MasterAdminLoginMaster"
            };
            mapping.ColumnMappings.Add("MasterAdminUserID", "MasterAdminUserID");
            ...
            mapping.ColumnMappings.Add("EmailID", "EmailID");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_MasterAdminLoginMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@MasterAdminUserID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "MasterAdminUserID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_MasterAdminLoginMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@MasterAdminUserID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "MasterAdminUserID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@EmailID", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "EmailID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_MasterAdminLoginMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@MasterAdminUserID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "MasterAdminUserID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@EmailID", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "EmailID", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_MasterAdminLoginMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_MasterAdminLoginMaster_SelectByMasterAdminUserID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@MasterAdminUserID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "dbo.PR_MasterAdminLoginMaster_SelectBySystemUserName";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@UserName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? MasterAdminUserID, string FirstName, string LastName, string UserName, string EmailID)
        {
            int num2;
            if (MasterAdminUserID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = MasterAdminUserID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[2].Value = FirstName;
            }
            if (LastName == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = LastName;
            }
            if (UserName == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[4].Value = UserName;
            }
            if (EmailID == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[5].Value = EmailID;
            }
            ...
            try
            {
                ...
                {
                    MasterAdminUserID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "MasterAdminLoginMaster");
        }
        ...
        public virtual int Update(int? MasterAdminUserID, string FirstName, string LastName, string UserName, string EmailID)
        {
            int num2;
            if (MasterAdminUserID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = MasterAdminUserID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = FirstName;
            }
            if (LastName == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = LastName;
            }
            if (UserName == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = UserName;
            }
            if (EmailID == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = EmailID;
            }
