...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class TeamSummaryTableAdapter : Component
    {
        ...
        public TeamSummaryTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.TeamSummaryDataTable dataTable, int? CompanyID, string EntryFor)
        {
        ...
        public virtual CloudAccountDA.TeamSummaryDataTable GetDataByMonth(int? CompanyID, string EntryFor)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.TeamSummaryDataTable dataTable = new CloudAccountDA.TeamSummaryDataTable();
        ...
        public virtual CloudAccountDA.TeamSummaryDataTable GetDataByWeek(int? CompanyID, string EntryFor)
        {
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_TeamSummary_SelectAllByMonth";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_TeamSummary_SelectAllByWeek";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@EntryFor", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
