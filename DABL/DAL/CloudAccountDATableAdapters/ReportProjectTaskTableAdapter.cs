...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ReportProjectTaskTableAdapter : Component
    {
        ...
        public ReportProjectTaskTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.ReportProjectTaskDataTable dataTable, int? CompanyID, int? TaskID, DateTime? FromDate, DateTime? ToDate)
        {
        ...
        public virtual CloudAccountDA.ReportProjectTaskDataTable GetData(int? CompanyID, int? TaskID, DateTime? FromDate, DateTime? ToDate)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.ReportProjectTaskDataTable dataTable = new CloudAccountDA.ReportProjectTaskDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ReportProjectTask"
            };
            mapping.ColumnMappings.Add("Project Name", "Project Name");
            mapping.ColumnMappings.Add("Assigned Users", "Assigned Users");
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_ProjectTask";
