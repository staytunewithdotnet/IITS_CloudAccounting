...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class AboutContentMasterTableAdapter : Component
    {
        ...
        public AboutContentMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? AboutContentID)
        {
            int num2;
            if (AboutContentID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = AboutContentID.Value;
            }
            else
            {
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false), DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual CloudAccountDA.AboutContentMasterDataTable GetDataByAboutContentID(int? AboutContentID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if (AboutContentID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = AboutContentID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "AboutContentMaster"
            };
            mapping.ColumnMappings.Add("AboutContentID", "AboutContentID");
            mapping.ColumnMappings.Add("AboutCategoryID", "AboutCategoryID");
            mapping.ColumnMappings.Add("AboutContent", "AboutContent");
            mapping.ColumnMappings.Add("AboutContentImage", "AboutContentImage");
            mapping.ColumnMappings.Add("AboutContentStatus", "AboutContentStatus");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_AboutContentMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@AboutContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AboutContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_AboutContentMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AboutContentID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "AboutContentID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AboutCategoryID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AboutCategoryID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AboutContent", SqlDbType.VarChar, 0x7fffffff, ParameterDirection.Input, 0, 0, "AboutContent", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AboutContentImage", SqlDbType.Image, 0x7fffffff, ParameterDirection.Input, 0, 0, "AboutContentImage", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@AboutContentStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "AboutContentStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_AboutContentMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@AboutContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "AboutContentID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@AboutContent", SqlDbType.VarChar, 0x7fffffff, ParameterDirection.Input, 0, 0, "AboutContent", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@AboutContentImage", SqlDbType.Image, 0x7fffffff, ParameterDirection.Input, 0, 0, "AboutContentImage", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@AboutContentStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "AboutContentStatus", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_AboutContentMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_AboutContentMaster_SelectByAboutCategoryID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_AboutContentMaster_SelectByAboutContentID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@AboutContentID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? AboutContentID, int? AboutCategoryID, string AboutContent, byte[] AboutContentImage, bool? AboutContentStatus)
        {
            int num2;
            if (AboutContentID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = AboutContentID.Value;
            }
            else
            {
            ...
            if (AboutCategoryID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[2].Value = AboutCategoryID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = AboutContent;
            }
            if (AboutContentImage == null)
            {
                this.Adapter.InsertCommand.Parameters[4].Value = DBNull.Value;
            }
            else
            {
                this.Adapter.InsertCommand.Parameters[4].Value = AboutContentImage;
            }
            if (AboutContentStatus.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[5].Value = AboutContentStatus.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    AboutContentID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "AboutContentMaster");
        }
        ...
        public virtual int Update(int? AboutContentID, int? AboutCategoryID, string AboutContent, byte[] AboutContentImage, bool? AboutContentStatus)
        {
            int num2;
            if (AboutContentID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = AboutContentID.Value;
            }
            else
            {
            ...
            if (AboutCategoryID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = AboutCategoryID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = AboutContent;
            }
            if (AboutContentImage == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = AboutContentImage;
            }
            if (AboutContentStatus.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = AboutContentStatus.Value;
            }
            else
            {
