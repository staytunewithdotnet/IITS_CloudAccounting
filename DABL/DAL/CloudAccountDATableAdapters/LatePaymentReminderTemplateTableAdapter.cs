...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class LatePaymentReminderTemplateTableAdapter : Component
    {
        ...
        public LatePaymentReminderTemplateTableAdapter()
        {
        ...
        public virtual int Delete(int? LatePaymentReminderID)
        {
            int num2;
            if (LatePaymentReminderID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = LatePaymentReminderID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.LatePaymentReminderTemplateDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.LatePaymentReminderTemplateDataTable dataTable = new CloudAccountDA.LatePaymentReminderTemplateDataTable();
        ...
        public virtual int Fill(CloudAccountDA.LatePaymentReminderTemplateDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.LatePaymentReminderTemplateDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.LatePaymentReminderTemplateDataTable dataTable = new CloudAccountDA.LatePaymentReminderTemplateDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual CloudAccountDA.LatePaymentReminderTemplateDataTable GetDataByCompanyID(int? CompanyID, int? Reminder)
        {
            ...
            {
                this.Adapter.SelectCommand.Parameters[2].Value = Reminder.Value;
            }
            else
            {
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "LatePaymentReminderTemplate"
            };
            mapping.ColumnMappings.Add("LatePaymentReminderID", "LatePaymentReminderID");
            mapping.ColumnMappings.Add("CompanyID", "CompanyID");
            mapping.ColumnMappings.Add("Reminder", "Reminder");
            mapping.ColumnMappings.Add("Enable", "Enable");
            mapping.ColumnMappings.Add("Days", "Days");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_LatePaymentReminderTemplate_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@LatePaymentReminderID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "LatePaymentReminderID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_LatePaymentReminderTemplate_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@LatePaymentReminderID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "LatePaymentReminderID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@Reminder", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "Reminder", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@Days", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "Days", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_LatePaymentReminderTemplate_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@LatePaymentReminderID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "LatePaymentReminderID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Reminder", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "Reminder", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Days", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "Days", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_LatePaymentReminderTemplate_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_LatePaymentReminderTemplate_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_LatePaymentReminderTemplate_SelectByCompanyID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@Reminder", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? LatePaymentReminderID, int? CompanyID, int? Reminder, bool? Enable, int? Days, string EmailSubject, string EmailBody)
        {
            int num2;
            if (LatePaymentReminderID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = LatePaymentReminderID.Value;
            }
            else
            {
            ...
            if (Reminder.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[3].Value = Reminder.Value;
            }
            else
            {
            ...
            if (Days.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[5].Value = Days.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[6].Value = EmailSubject;
            }
            if (EmailBody == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[7].Value = EmailBody;
            }
            ...
            try
            {
                ...
                {
                    LatePaymentReminderID = 0;
                }
                else
                {
                    LatePaymentReminderID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "LatePaymentReminderTemplate");
        }
        
        [DebuggerNonUserCode, HelpKeyword("vs.data.TableAdapter"), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int Update(CloudAccountDA.LatePaymentReminderTemplateDataTable dataTable)
        {
        ...
        public virtual int Update(int? LatePaymentReminderID, int? CompanyID, int? Reminder, bool? Enable, int? Days, string EmailSubject, string EmailBody)
        {
            int num2;
            if (LatePaymentReminderID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = LatePaymentReminderID.Value;
            }
            else
            {
            ...
            if (Reminder.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = Reminder.Value;
            }
            else
            {
            ...
            if (Days.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = Days.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[6].Value = EmailSubject;
            }
            if (EmailBody == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[7].Value = EmailBody;
            }
