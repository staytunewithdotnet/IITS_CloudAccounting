...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class TaxMasterTableAdapter : Component
    {
        ...
        public virtual int Delete(int? TaxID)
        {
            int num2;
            if (TaxID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = TaxID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.TaxMasterDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.TaxMasterDataTable GetDataByTaxID(int? TaxID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if (TaxID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = TaxID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "TaxMaster"
            };
            mapping.ColumnMappings.Add("TaxID", "TaxID");
            mapping.ColumnMappings.Add("CompanyID", "CompanyID");
            mapping.ColumnMappings.Add("TaxName", "TaxName");
            mapping.ColumnMappings.Add("TaxRate", "TaxRate");
            mapping.ColumnMappings.Add("TaxNumber", "TaxNumber");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_TaxMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@TaxID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "TaxID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_TaxMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TaxID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "TaxID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TaxName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "TaxName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TaxRate", SqlDbType.Decimal, 5, ParameterDirection.Input, 6, 2, "TaxRate", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TaxNumber", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "TaxNumber", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_TaxMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TaxID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "TaxID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TaxName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "TaxName", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TaxRate", SqlDbType.Decimal, 5, ParameterDirection.Input, 6, 2, "TaxRate", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TaxNumber", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "TaxNumber", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_TaxMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_TaxMaster_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_TaxMaster_SelectByCompanyID";
            ...
            this._commandCollection[3].CommandText = "dbo.PR_TaxMaster_SelectByTaxID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@TaxID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "dbo.PR_TaxMaster_SelectByTaxName";
            ...
            this._commandCollection[4].Parameters.Add(new SqlParameter("@TaxName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? TaxID, int? CompanyID, string TaxName, decimal? TaxRate, string TaxNumber)
        {
            int num2;
            if (TaxID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = TaxID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = TaxName;
            }
            if (TaxRate.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[4].Value = TaxRate.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[5].Value = TaxNumber;
            }
            ...
            try
            {
                ...
                {
                    TaxID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "TaxMaster");
        }
        ...
        public virtual int Update(int? TaxID, int? CompanyID, string TaxName, decimal? TaxRate, string TaxNumber)
        {
            int num2;
            if (TaxID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = TaxID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = TaxName;
            }
            if (TaxRate.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = TaxRate.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = TaxNumber;
            }
