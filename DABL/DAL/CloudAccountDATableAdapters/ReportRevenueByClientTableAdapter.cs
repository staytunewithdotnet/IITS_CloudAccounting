...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ReportRevenueByClientTableAdapter : Component
    {
        ...
        public ReportRevenueByClientTableAdapter()
        {
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_RevenueByClient";
            ...
            this._commandCollection[0].Parameters.Add(new SqlParameter("@RevenueFor", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
