...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class CreditDefaultTermsMasterTableAdapter : Component
    {
        ...
        public CreditDefaultTermsMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? CreditDefaultTermsID)
        {
            int num2;
            if (CreditDefaultTermsID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = CreditDefaultTermsID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.CreditDefaultTermsMasterDataTable DeleteByCompanyID(int? CompanyID)
        {
            ...
            CloudAccountDA.CreditDefaultTermsMasterDataTable dataTable = new CloudAccountDA.CreditDefaultTermsMasterDataTable();
        ...
        public virtual int Fill(CloudAccountDA.CreditDefaultTermsMasterDataTable dataTable)
        {
        ...
        public virtual CloudAccountDA.CreditDefaultTermsMasterDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CloudAccountDA.CreditDefaultTermsMasterDataTable dataTable = new CloudAccountDA.CreditDefaultTermsMasterDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode, DataObjectMethod(DataObjectMethodType.Select, false), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual CloudAccountDA.CreditDefaultTermsMasterDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.CreditDefaultTermsMasterDataTable GetDataByCreditDefaultTermsID(int? CreditDefaultTermsID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if (CreditDefaultTermsID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = CreditDefaultTermsID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "CreditDefaultTermsMaster"
            };
            mapping.ColumnMappings.Add("CreditDefaultTermsID", "CreditDefaultTermsID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_CreditDefaultTermsMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@CreditDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CreditDefaultTermsID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_CreditDefaultTermsMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CreditDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "CreditDefaultTermsID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_CreditDefaultTermsMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CreditDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CreditDefaultTermsID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_CreditDefaultTermsMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_CreditDefaultTermsMaster_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_CreditDefaultTermsMaster_SelectByCompanyID";
            ...
            this._commandCollection[3].CommandText = "dbo.PR_CreditDefaultTermsMaster_SelectByCreditDefaultTermsID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@CreditDefaultTermsID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? CreditDefaultTermsID, int? CompanyID, string DefaultTerms)
        {
            int num2;
            if (CreditDefaultTermsID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = CreditDefaultTermsID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    CreditDefaultTermsID = 0;
                }
                else
                {
                    CreditDefaultTermsID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "CreditDefaultTermsMaster");
        }
        
        [HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int Update(CloudAccountDA.CreditDefaultTermsMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? CreditDefaultTermsID, int? CompanyID, string DefaultTerms)
        {
            int num2;
            if (CreditDefaultTermsID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = CreditDefaultTermsID.Value;
            }
            else
            {
