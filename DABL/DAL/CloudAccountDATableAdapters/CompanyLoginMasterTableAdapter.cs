...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class CompanyLoginMasterTableAdapter : Component
    {
        ...
        public CompanyLoginMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? CompanyLoginID)
        {
            int num2;
            if (CompanyLoginID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = CompanyLoginID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.CompanyLoginMasterDataTable GetDataByCompanyLoginID(int? CompanyLoginID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if (CompanyLoginID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = CompanyLoginID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "CompanyLoginMaster"
            };
            mapping.ColumnMappings.Add("CompanyLoginID", "CompanyLoginID");
            ...
            mapping.ColumnMappings.Add("CompanyStatus", "CompanyStatus");
            this._adapter.TableMappings.Add(mapping);
            this._adapter.DeleteCommand = new SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "dbo.PR_CompanyLoginMaster_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@CompanyLoginID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CompanyLoginID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_CompanyLoginMaster_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CompanyLoginID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "CompanyLoginID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@CompanyStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "CompanyStatus", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "dbo.PR_CompanyLoginMaster_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CompanyLoginID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "CompanyLoginID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CompanyStatus", SqlDbType.Bit, 1, ParameterDirection.Input, 1, 0, "CompanyStatus", DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_CompanyLoginMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_CompanyLoginMaster_SelectByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_CompanyLoginMaster_SelectByCompanyLoginID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@CompanyLoginID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_CompanyLoginMaster_SelectByCompanyUserName";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@CompanyUserName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? CompanyLoginID, int? CompanyID, string CompanyUserName, string CompanyEmail, bool? CompanyStatus)
        {
            int num2;
            if (CompanyLoginID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = CompanyLoginID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[3].Value = CompanyUserName;
            }
            ...
            {
                this.Adapter.InsertCommand.Parameters[4].Value = CompanyEmail;
            }
            if (CompanyStatus.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[5].Value = CompanyStatus.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    CompanyLoginID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "CompanyLoginMaster");
        }
        
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.CompanyLoginMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? CompanyLoginID, int? CompanyID, string CompanyUserName, string CompanyEmail, bool? CompanyStatus)
        {
            int num2;
            if (CompanyLoginID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = CompanyLoginID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = CompanyUserName;
            }
            if (CompanyEmail == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = CompanyEmail;
            }
            if (CompanyStatus.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = CompanyStatus.Value;
            }
            else
            {
