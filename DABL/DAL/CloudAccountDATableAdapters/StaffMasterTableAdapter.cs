...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class StaffMasterTableAdapter : Component
    {
        ...
        public StaffMasterTableAdapter()
        {
        ...
        public virtual int Delete(int? StaffID)
        {
            int num2;
            if (StaffID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = StaffID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.StaffMasterDataTable GetDataByCompanyID(int? CompanyID)
        {
        ...
        public virtual CloudAccountDA.StaffMasterDataTable GetDataByStaffID(int? StaffID)
        {
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_StaffMaster_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_StaffMaster_DeleteByCompanyID";
            ...
            this._commandCollection[2].CommandText = "dbo.PR_StaffMaster_SelectByCompanyID";
            ...
            this._commandCollection[3].CommandText = "dbo.PR_StaffMaster_SelectByCompanyIDAndEmail";
            ...
            this._commandCollection[4].CommandText = "dbo.PR_StaffMaster_SelectByStaffID";
            ...
            this._commandCollection[5].CommandText = "dbo.PR_StaffMaster_SelectByStaffUserName";
            ...
            this._commandCollection[5].Parameters.Add(new SqlParameter("@UserName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6] = new SqlCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = "dbo.PR_StaffMaster_UpdateWhenAnyBit";
            ...
            this._commandCollection[7].CommandText = "dbo.PR_StaffMaster_UpdateWhenDelete";
        ...
        public virtual int Insert(ref int? StaffID, int? CompanyID, string Email, string FirstName, string LastName, decimal? BillingRate, string UserName, string Address1, string Address2, int? CountryID, int? StateID, int? CityID, string ZipCode, string HomePhone, string Mobile, string BussinessPhone, string Fax, string Notes, bool? Active, bool? Archived, bool? Deleted)
        {
            ...
            {
                this.Adapter.InsertCommand.Parameters[4].Value = FirstName;
            }
            if (LastName == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[5].Value = LastName;
            }
            ...
            {
                this.Adapter.InsertCommand.Parameters[7].Value = UserName;
            }
            if (Address1 == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[8].Value = Address1;
            }
            if (Address2 == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[9].Value = Address2;
            }
            if (CountryID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[10].Value = CountryID.Value;
            }
            else
            {
            ...
            if (StateID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[11].Value = StateID.Value;
            }
            else
            {
            ...
            if (CityID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[12].Value = CityID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[13].Value = ZipCode;
            }
            if (HomePhone == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[14].Value = HomePhone;
            }
            if (Mobile == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[15].Value = Mobile;
            }
            ...
            {
                this.Adapter.InsertCommand.Parameters[0x10].Value = BussinessPhone;
            }
            if (Fax == null)
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[0x11].Value = Fax;
            }
            if (Notes == null)
            {
            ...
            if (Active.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[0x13].Value = Active.Value;
            }
            else
            {
            ...
            {
                this.Adapter.InsertCommand.Parameters[20].Value = Archived.Value;
            }
            else
            {
            ...
            if (Deleted.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[0x15].Value = Deleted.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    StaffID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "StaffMaster");
        }
        
        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(CloudAccountDA.StaffMasterDataTable dataTable)
        {
        ...
        public virtual int Update(int? StaffID, int? CompanyID, string Email, string FirstName, string LastName, decimal? BillingRate, string UserName, string Address1, string Address2, int? CountryID, int? StateID, int? CityID, string ZipCode, string HomePhone, string Mobile, string BussinessPhone, string Fax, string Notes, bool? Active, bool? Archived, bool? Deleted)
        {
            int num2;
            if (StaffID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = StaffID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[4].Value = FirstName;
            }
            if (LastName == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[5].Value = LastName;
            }
            if (BillingRate.HasValue)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[7].Value = UserName;
            }
            if (Address1 == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[8].Value = Address1;
            }
            if (Address2 == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[9].Value = Address2;
            }
            if (CountryID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[10].Value = CountryID.Value;
            }
            else
            {
            ...
            if (StateID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[11].Value = StateID.Value;
            }
            else
            {
            ...
            if (CityID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[12].Value = CityID.Value;
            }
            else
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[13].Value = ZipCode;
            }
            if (HomePhone == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[14].Value = HomePhone;
            }
            if (Mobile == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[15].Value = Mobile;
            }
            if (BussinessPhone == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[0x10].Value = BussinessPhone;
            }
            if (Fax == null)
            {
            ...
            {
                this.Adapter.UpdateCommand.Parameters[0x11].Value = Fax;
            }
            if (Notes == null)
            {
            ...
            if (Active.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[0x13].Value = Active.Value;
            }
            else
            {
            ...
            if (Archived.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[20].Value = Archived.Value;
            }
            else
            {
            ...
            if (Deleted.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[0x15].Value = Deleted.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.StaffMasterDataTable UpdateWhenAnyBit(int? StaffID, bool? Active, bool? Deleted, bool? Archived)
        {
