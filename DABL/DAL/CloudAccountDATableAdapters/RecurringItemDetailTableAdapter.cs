...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class RecurringItemDetailTableAdapter : Component
    {
        ...
        public RecurringItemDetailTableAdapter()
        {
        ...
        public virtual int Delete(int? RecurringItemDetailID)
        {
            int num2;
            if (RecurringItemDetailID.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = RecurringItemDetailID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.RecurringItemDetailDataTable DeleteByItemID(int? ItemID)
        {
        ...
        public virtual CloudAccountDA.RecurringItemDetailDataTable GetDataByItemID(int? ItemID)
        {
        ...
        public virtual CloudAccountDA.RecurringItemDetailDataTable GetDataByRecurringID(int? RecurringID)
        {
        ...
        public virtual CloudAccountDA.RecurringItemDetailDataTable GetDataByRecurringItemDetailID(int? RecurringItemDetailID)
        {
            this.Adapter.SelectCommand = this.CommandCollection[5];
            if (RecurringItemDetailID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[1].Value = RecurringItemDetailID.Value;
            }
            else
            {
                this.Adapter.SelectCommand.Parameters[1].Value = DBNull.Value;
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "RecurringItemDetail"
            };
            mapping.ColumnMappings.Add("RecurringItemDetailID", "RecurringItemDetailID");
            ...
            this._adapter.DeleteCommand.CommandText = "dbo.PR_RecurringItemDetail_Delete";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@RecurringItemDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "RecurringItemDetailID", DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand = new SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "dbo.PR_RecurringItemDetail_Insert";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@RecurringItemDetailID", SqlDbType.Int, 4, ParameterDirection.InputOutput, 10, 0, "RecurringItemDetailID", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "dbo.PR_RecurringItemDetail_Update";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@RecurringItemDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "RecurringItemDetailID", DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_RecurringItemDetail_SelectAll";
            ...
            this._commandCollection[1].CommandText = "dbo.PR_RecurringItemDetail_DeleteByItemID";
            ...
            this._commandCollection[1].Parameters.Add(new SqlParameter("@ItemID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "dbo.PR_RecurringItemDetail_DeleteByRecurringID";
            ...
            this._commandCollection[2].Parameters.Add(new SqlParameter("@RecurringID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.PR_RecurringItemDetail_SelectByItemID";
            ...
            this._commandCollection[3].Parameters.Add(new SqlParameter("@ItemID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "dbo.PR_RecurringItemDetail_SelectByRecurringID";
            ...
            this._commandCollection[4].Parameters.Add(new SqlParameter("@RecurringID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[5] = new SqlCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "dbo.PR_RecurringItemDetail_SelectByRecurringItemDetailID";
            ...
            this._commandCollection[5].Parameters.Add(new SqlParameter("@RecurringItemDetailID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(ref int? RecurringItemDetailID, int? RecurringID, int? ItemID, string ItemDesc, decimal? UnitCost, decimal? Quantity, int? Tax1, int? Tax2, decimal? Total)
        {
            int num2;
            if (RecurringItemDetailID.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = RecurringItemDetailID.Value;
            }
            else
            {
            ...
            try
            {
                ...
                {
                    RecurringItemDetailID = 0;
                }
                else
                {
                    RecurringItemDetailID = new int?((int) this.Adapter.InsertCommand.Parameters[1].Value);
                }
                num2 = num;
            }
            finally
        ...
        {
            return this.Adapter.Update(dataSet, "RecurringItemDetail");
        }
        ...
        public virtual int Update(int? RecurringItemDetailID, int? RecurringID, int? ItemID, string ItemDesc, decimal? UnitCost, decimal? Quantity, int? Tax1, int? Tax2, decimal? Total)
        {
            int num2;
            if (RecurringItemDetailID.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = RecurringItemDetailID.Value;
            }
            else
            {
