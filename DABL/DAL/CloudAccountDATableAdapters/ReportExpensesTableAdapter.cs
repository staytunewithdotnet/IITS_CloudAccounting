...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class ReportExpensesTableAdapter : Component
    {
        ...
        public ReportExpensesTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.ReportExpensesDataTable dataTable, int? CompanyID, int? SubCategoryID, DateTime? FromDate, DateTime? ToDate)
        {
            ...
            {
                this.Adapter.SelectCommand.Parameters[2].Value = SubCategoryID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.ReportExpensesDataTable GetData(int? CompanyID, int? SubCategoryID, DateTime? FromDate, DateTime? ToDate)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.ReportExpensesDataTable dataTable = new CloudAccountDA.ReportExpensesDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "ReportExpenses"
            };
            mapping.ColumnMappings.Add("Date", "Date");
            mapping.ColumnMappings.Add("Category", "Category");
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_Report_Expenses";
            ...
            this._commandCollection[0].Parameters.Add(new SqlParameter("@SubCategoryID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, null, DataRowVersion.Current, false, null, "", "", ""));
