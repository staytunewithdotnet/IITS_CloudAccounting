...
namespace DABL.DAL.CloudAccountDATableAdapters
{
    ...
    public class TimesheetGridMasterTableAdapter : Component
    {
        ...
        public TimesheetGridMasterTableAdapter()
        {
        ...
        public virtual int Fill(CloudAccountDA.TimesheetGridMasterDataTable dataTable, int? CompanyID, int? ProjectID, int? TaskID, string EntryFor)
        {
            ...
            if (TaskID.HasValue)
            {
                this.Adapter.SelectCommand.Parameters[3].Value = TaskID.Value;
            }
            else
            {
        ...
        public virtual CloudAccountDA.TimesheetGridMasterDataTable GetData(int? CompanyID, int? ProjectID, int? TaskID, string EntryFor)
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if (CompanyID.HasValue)
            {
            ...
            CloudAccountDA.TimesheetGridMasterDataTable dataTable = new CloudAccountDA.TimesheetGridMasterDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "TimesheetGridMaster"
            };
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "dbo.PR_TimesheetGridMaster_SelectAll";
