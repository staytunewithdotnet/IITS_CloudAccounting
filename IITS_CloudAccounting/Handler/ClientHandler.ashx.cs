...
// Type: IITS_CloudAccounting.Handler.ClientHandler
...
namespace IITS_CloudAccounting.Handler
{
  ...
  {
    private readonly ClientMasterBLL _objClientMasterBll = new ClientMasterBLL();
    private CloudAccountDA.ClientMasterDataTable _objClientMasterDt = new CloudAccountDA.ClientMasterDataTable();
