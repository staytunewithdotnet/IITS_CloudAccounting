<%@ Page Title="Project Master" Language="C#" MasterPageFile="~/BillTransact/Doyingo.Master" AutoEventWireup="true" CodeBehind="ProjectMaster.aspx.cs" Inherits="IITS_CloudAccounting.Admin.ProjectMaster" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="ProjectMaster.aspx">Project Master</a>
                </li>
            </ol>
        </div>
    </div>
                    ...
                    <ContentTemplate>
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <b style="font-size: 14px;">Project Information</b>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8" style="color: black; font-family: Verdana,sans-serif;">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="sqldsClient" ConnectionString='<%$ ConnectionStrings:IITS_CloudAccountConnectionString %>' SelectCommand="SELECT '0' AS ID,'- internal -' AS Name UNION SELECT CompanyClientID,(OrganizationName +'('+ LastName +','+ FirstName +')')AS Name FROM CompanyClientMaster WHERE CompanyID = @CompanyID">
                                        <SelectParameters>
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="sqldsStaff" ConnectionString='<%$ ConnectionStrings:IITS_CloudAccountConnectionString %>' SelectCommand="SELECT '0' AS ID,'You' AS Name UNION SELECT (StaffID) AS ID,(LastName+','+FirstName) AS Name FROM StaffMaster WHERE CompanyID = @CompanyID AND (Active = 1 OR Archived = 1)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID"></asp:ControlParameter>
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                            ...
                            <div class="col-lg-8" style="color: black; font-family: Verdana,sans-serif;">
                                <asp:GridView runat="server" ID="gvUsers" Width="100%" CssClass="table table-striped gridTable" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Rate" HeaderText="Rate" ReadOnly="True" SortExpression="Rate"></asp:BoundField>--%>
                                ...
                                <asp:SqlDataSource runat="server" ID="sqldsUser" ConnectionString='<%$ ConnectionStrings:IITS_CloudAccountConnectionString %>' SelectCommand="SELECT '0' AS ID,'You' AS Name,0 AS Rate,'Admin' AS Role UNION SELECT (StaffID) AS ID,(LastName+','+FirstName) AS Name,BillingRate AS Rate,'Staff' AS Role FROM StaffMaster WHERE CompanyID = @CompanyID UNION SELECT (ContractorID) AS ID,(ContractorName) AS Name,RebillRate AS Rate,'Contractor' AS Role FROM ContractorMaster WHERE CompanyID = @CompanyID">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID"></asp:ControlParameter>
                                    </SelectParameters>
                                </asp:SqlDataSource>
        ...
        <asp:Panel runat="server" ID="pnlView">
            ...
            <div class="col-lg-8">
                <div class=" rounded-container peel-shadows bg_systemcolor1">
                    <br />
                    <span class="col-lg-12" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold;color: black;">Hours For Team</span>
                    <br />
                    <br />
                    ...
                    <span class="col-lg-12" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold;color: black;">Hours By Task</span>
                    <br />
                    <br />
            ...
            <div class="panel-body" style="padding-left: 0; padding-right: 0;">
                <div class="col-lg-12" style="padding-left: 0; padding-right: 0;">
                    ...
                    <asp:GridView runat="server" ID="gvProject" Width="100%" Font-Size="Small" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Project Name">
                                <ItemTemplate>
                                    <a href='<%# "ProjectMaster.aspx?cmd=view&ID=" + Eval("ProjectID") %>'>
                                        <%#Eval("ProjectName") %>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <%--<asp:TemplateField HeaderText="Estimate">
                                <ItemTemplate>
                                    <div class="progress" style="margin-bottom: 0;">
                                        <div class="progress-bar progress-bar-progress" style='width: <%# GetWidthProject(Eval("ProjectID").ToString())%>'></div>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                        </Columns>
                    ...
                    <div style="background-color: white; border-bottom: 1px solid lightgray; text-align: right;">
                        <a id="activeTag" runat="server" href="ProjectMaster.aspx">active</a>
                        &nbsp; | &nbsp;
                        <a id="archivedTag" runat="server" href="ProjectMaster.aspx?ar=true&ac=false">archived</a>
                        &nbsp; | &nbsp;
                        <a id="deletedTag" runat="server" href="ProjectMaster.aspx?de=true&ac=false">deleted</a>
                        <div>&nbsp;</div>
                    </div>
