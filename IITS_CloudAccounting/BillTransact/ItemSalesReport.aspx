<%@ Page Title="Item Sales Report" Language="C#" MasterPageFile="~/BillTransact/Doyingo.Master" AutoEventWireup="true" CodeBehind="ItemSalesReport.aspx.cs" Inherits="IITS_CloudAccounting.Admin.ItemSalesReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin-top: -45px;">
        <div class="col-sm-12">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="ItemSalesReport.aspx">Item Sales</a>
                </li>
            </ol>
        </div>
    </div>
    <div class="col-lg-12" style="color: black; font-family: Verdana,sans-serif; min-height: 110px">
        <div class="page-header">
            <h1 style="display: inline-block">Item Sales</h1>
        ...
        <div class="panel-body" style="background-color: #f1f1f1; margin-bottom: 20px;">
            ...
            <div class="col-lg-2">
                ...
                <asp:DropDownList runat="server" ID="ddlItems" CssClass="form-control text" DataSourceID="sqldsItems" DataTextField="ItemName" DataValueField="ItemID" />
                <asp:SqlDataSource runat="server" ID="sqldsItems" ConnectionString='<%$ ConnectionStrings:IITS_CloudAccountConnectionString %>' SelectCommand="SELECT DISTINCT a.[ItemID],[ItemName] FROM InvoiceItemDetail a LEFT JOIN ItemMaster c on a.ItemID = c.ItemID WHERE CompanyID = @CompanyID UNION SELECT NULL,'All'">
                    <SelectParameters>
        ...
        <div id="printDiv" class="panel-body rounded-container peel-shadows" style="background-color: #fff !important; color: #000 !important;">
            ...
            <div class="col-lg-12" style="text-align: center">
                <h1 style="margin-bottom: 0;">Item Sales
                </h1>
