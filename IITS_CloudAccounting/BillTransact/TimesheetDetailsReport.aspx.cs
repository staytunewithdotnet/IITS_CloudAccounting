...
// Type: IITS_CloudAccounting.Admin.TimesheetDetailsReport
...
{
  public class TimesheetDetailsReport : Page
  {
    ...
    private readonly ReportTimesheetDetailsTeamBLL objReportTimesheetDetailsTeamBll = new ReportTimesheetDetailsTeamBLL();
    private CloudAccountDA.ReportTimesheetDetailsTeamDataTable objReportTimesheetDetailsTeamDT = new CloudAccountDA.ReportTimesheetDetailsTeamDataTable();
    private readonly ReportTimesheetDetailsClientBLL objReportTimesheetDetailsClientBll = new ReportTimesheetDetailsClientBLL();
    private CloudAccountDA.ReportTimesheetDetailsClientDataTable objReportTimesheetDetailsClientDT = new CloudAccountDA.ReportTimesheetDetailsClientDataTable();
    private readonly ReportTimesheetDetailsProjectBLL objReportTimesheetDetailsProjectBll = new ReportTimesheetDetailsProjectBLL();
    private CloudAccountDA.ReportTimesheetDetailsProjectDataTable objReportTimesheetDetailsProjectDT = new CloudAccountDA.ReportTimesheetDetailsProjectDataTable();
    private readonly ReportTimesheetDetailsTaskBLL objReportTimesheetDetailsTaskBll = new ReportTimesheetDetailsTaskBLL();
    private CloudAccountDA.ReportTimesheetDetailsTaskDataTable objReportTimesheetDetailsTaskDT = new CloudAccountDA.ReportTimesheetDetailsTaskDataTable();
    ...
    private void BindGrid()
    {
      ...
      if (this.ddlGroupBy.SelectedItem.Text == "Team")
      {
        ...
        {
          this.objReportTimesheetDetailsTeamDT = this.objReportTimesheetDetailsTeamBll.GetData(int.Parse(this.hfCompanyID.Value), this.ddlTeam.SelectedItem.Text, iProjectID, bBilled, dtFromDate, dtToDate);
          ...
          gridView1.DataSource = (object) this.objReportTimesheetDetailsTeamDT;
        ...
        else
        {
          ...
          foreach (ListItem listItem in this.ddlTeam.Items)
          {
            ...
            {
              this.objReportTimesheetDetailsTeamDT = this.objReportTimesheetDetailsTeamBll.GetData(int.Parse(this.hfCompanyID.Value), listItem.Value, iProjectID, bBilled, dtFromDate, dtToDate);
              Label label = new Label()
              {
                Text = listItem.Text
              };
      ...
      else if (this.ddlGroupBy.SelectedItem.Text == "Client")
      {
        ...
        foreach (ListItem listItem in this.ddlClient.Items)
        {
          if (!string.IsNullOrEmpty(listItem.Value))
          {
            this.objReportTimesheetDetailsClientDT = this.objReportTimesheetDetailsClientBll.GetData(int.Parse(this.hfCompanyID.Value), new int?(int.Parse(listItem.Value)), iProjectID, bBilled, dtFromDate, dtToDate);
            Label label = new Label()
            {
              Text = listItem.Text
            };
            ...
            this.divGrids.Controls.Add((Control) new LiteralControl("<br />"));
            GridView gridView1 = new GridView();
            gridView1.DataSource = (object) this.objReportTimesheetDetailsClientDT;
            gridView1.CssClass = "reportTable table table-responsive";
            gridView1.Width = Unit.Percentage(100.0);
            gridView1.GridLines = GridLines.None;
            gridView1.EmptyDataText = "No Timesheet entry found";
      ...
      else if (this.ddlGroupBy.SelectedItem.Text == "Project")
      {
        if (this.ddlProject.SelectedIndex > 0)
        {
          ...
          if (this.ddlProject.SelectedIndex > 0)
            iProjectID = new int?(int.Parse(this.ddlProject.SelectedItem.Value));
          this.objReportTimesheetDetailsProjectDT = this.objReportTimesheetDetailsProjectBll.GetData(int.Parse(this.hfCompanyID.Value), iProjectID, bBilled, dtFromDate, dtToDate);
          Label label = new Label()
          {
          ...
          this.divGrids.Controls.Add((Control) new LiteralControl("<br />"));
          GridView gridView1 = new GridView();
          gridView1.DataSource = (object) this.objReportTimesheetDetailsProjectDT;
          gridView1.CssClass = "reportTable table table-responsive";
          gridView1.Width = Unit.Percentage(100.0);
          gridView1.GridLines = GridLines.None;
          gridView1.EmptyDataText = "No Timesheet entry found";
        ...
        else
        {
          ...
          foreach (ListItem listItem in this.ddlProject.Items)
          {
            if (!string.IsNullOrEmpty(listItem.Value))
            {
              this.objReportTimesheetDetailsProjectDT = this.objReportTimesheetDetailsProjectBll.GetData(int.Parse(this.hfCompanyID.Value), new int?(int.Parse(listItem.Value)), bBilled, dtFromDate, dtToDate);
              Label label = new Label()
              {
                Text = listItem.Text
              };
      ...
      else
      {
        ...
        foreach (ListItem listItem in this.ddlTask.Items)
        {
          if (!string.IsNullOrEmpty(listItem.Value))
          {
            this.objReportTimesheetDetailsTaskDT = this.objReportTimesheetDetailsTaskBll.GetData(int.Parse(this.hfCompanyID.Value), int.Parse(listItem.Value), bBilled, dtFromDate, dtToDate);
            Label label = new Label()
            {
              Text = listItem.Text
            };
            ...
            this.divGrids.Controls.Add((Control) new LiteralControl("<br />"));
            GridView gridView1 = new GridView();
            gridView1.DataSource = (object) this.objReportTimesheetDetailsTaskDT;
            gridView1.CssClass = "reportTable table table-responsive";
            gridView1.Width = Unit.Percentage(100.0);
            gridView1.GridLines = GridLines.None;
            gridView1.EmptyDataText = "No Timesheet entry found";
