    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="InvoiceMasterNew.aspx">Invoice Master</a>
                </li>
            </ol>
        </div>
    </div>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="col-lg-12" style="padding-left: 0; padding-right: 0" id="clientInvoices" runat="server" visible="False">
                            ...
                            <asp:GridView runat="server" ID="gvPaidInvoice" Width="100%" AutoGenerateColumns="False" DataKeyNames="InvoiceID"
                                ...
                                OnRowDataBound="gvPaidInvoice_RowDataBound">
                                <Columns>
                            ...
                            <asp:GridView runat="server" ID="gvDueInvoice" Width="100%" AutoGenerateColumns="False" DataKeyNames="InvoiceID"
                                ...
                                OnRowDataBound="gvDueInvoice_RowDataBound">
                                <Columns>
                                    <asp:BoundField DataField="InvoiceID" HeaderText="InvoiceID" ReadOnly="True" InsertVisible="False" SortExpression="InvoiceID" Visible="False"></asp:BoundField>
                                    <asp:BoundField DataField="InvoiceNumber" HeaderText="Invoice Number" SortExpression="InvoiceNumber">
                                        <ItemStyle Width="15%" HorizontalAlign="Center"></ItemStyle>
                        ...
                        <asp:DataList runat="server" ID="dlHistory" Width="100%" DataKeyField="InvoiceDisputeHistoryID" DataSourceID="sqldsHistory" RepeatColumns="1" RepeatDirection="Vertical">
                            <ItemTemplate>
                                ...
                                <div class="col-lg-12 clearfix">
                                    <div class='<%# Eval("InvoiceDisputeCreatedBy").ToString() == "Company"?"col-lg-2 float_left":"col-lg-2 float_right" %>'>
                                        <div id="Div1" class="client-icon-medium bg-system-light" runat="server" visible='<%# Eval("InvoiceDisputeCreatedBy").ToString() != "Company" %>'></div>
                                        <div id="Div2" class="staff-icon-medium bg-system-light" runat="server" visible='<%# Eval("InvoiceDisputeCreatedBy").ToString() == "Company" %>'></div>
                                    </div>
                ...
                <div class="invbody">
                    ...
                    <div class="invoice-brand" id="brandingDiv" runat="server">
                        This invoice was sent using <a href="#" target="_blank" class="none">
                            <img style="margin-bottom: -1px; width: 56px; height: 23px" alt="Bill Transact" src="../App_Themes/sky/uploads/logo.png" />
                        </a>
                    </div>
                </div>
            ...
            <div class="panel-body" style="padding-left: 0; padding-right: 0;">
                <div class="col-lg-12" style="padding-left: 0; padding-right: 0;">
                    ...
                    <div style="background-color: lightgray; padding: 10px;">
                        ...
                        <asp:Button runat="server" ID="btnPaymentGrid" Text="Enter Payment" CssClass="btn-success" OnClick="btnPaymentGrid_Click" />
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Outstanding">
                                <ItemTemplate>
                                    ...
                                    <asp:Label runat="server" ID="lblBalancePending" Text='<%# GetCurrency(Eval("CurrencyID").ToString()) + " " + decimal.Round(decimal.Parse(Eval("InvoiceTotal").ToString())) %>'></asp:Label>
                    ...
                    <div style="background-color: white; border-bottom: 1px solid lightgray; text-align: right;">
                        <a id="activeTag" runat="server" href="InvoiceMasterNew.aspx">active</a>
                        &nbsp; | &nbsp;
                        <a id="archivedTag" runat="server" href="InvoiceMasterNew.aspx?ar=true&ac=false">archived</a>
                        &nbsp; | &nbsp;
                        <a id="deletedTag" runat="server" href="InvoiceMasterNew.aspx?de=true&ac=false">deleted</a>
                        <div>&nbsp;</div>
                    </div>
                    ...
                    <asp:ObjectDataSource runat="server" ID="objdsInvoice" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByInvoiceSearchCompany" TypeName="DABL.DAL.CloudAccountDATableAdapters.InvoiceMasterTableAdapter">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID" Type="Int32"></asp:ControlParameter>
                            <asp:QueryStringParameter QueryStringField="ac" DefaultValue="true" Type="Boolean" Name="Active" />
                            <asp:QueryStringParameter QueryStringField="ar" DefaultValue="false" Type="Boolean" Name="Archived" />
                    ...
                    <asp:ObjectDataSource runat="server" ID="objdsInvoiceStaff" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByInvoiceSearchStaff" TypeName="DABL.DAL.CloudAccountDATableAdapters.InvoiceMasterTableAdapter">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID" Type="Int32"></asp:ControlParameter>
                            <asp:ControlParameter ControlID="hfStaffID" PropertyName="Value" DefaultValue="0" Name="StaffID" Type="Int32"></asp:ControlParameter>
                            <asp:QueryStringParameter QueryStringField="ac" DefaultValue="true" Type="Boolean" Name="Active" />
