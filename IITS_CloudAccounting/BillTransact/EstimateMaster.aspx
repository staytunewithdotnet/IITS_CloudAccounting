...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="EstimateMaster.aspx">Estimate Master</a>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div id="divSave" runat="server" visible="False">
        ...
        <div class="col-lg-6">
            <div class="notification-page notification-success">
                <h3>Your Estimate has been created.</h3>
    ...
    <div id="divUpdate" runat="server" visible="False">
        ...
        <div class="col-lg-6">
            <div class="notification-page notification-success">
                <h3>Your Estimate has been updated.</h3>
                <ul style="color: black; font-family: Verdana; font-size: 13px;">
                    <li>Click to <a href="InvoiceMasterNew.aspx" class="permission">create an invoice</a>.
                    </li>
                    <li>Click to <a href="EstimateMaster.aspx" class="permission">create an estimate</a>.
    ...
    <div class="col-lg-8" style="color: black; font-family: Verdana,sans-serif;">
            ...
            <div class="panel-body">
                    ...
                    <ContentTemplate>
                        ...
                        <div class="col-lg-7 bookcase" id="clienDetails" runat="server" visible="False">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <asp:Label runat="server" ID="lblBoxClientFor" Text="" Style="color: #000; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-weight: bold; line-height: 24px;"></asp:Label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-6">
                                ...
                                <div class="holder">
                                    <div class="col-lg-7" style="padding-right: 0;">
                                        <asp:Label runat="server" ID="lblBoxClientInfo" Text="" Style="color: black; font-family: Verdana, sans-serif; font-size: 12px;"></asp:Label>
                                    </div>
                        ...
                        <div class="col-lg-5" style="padding-left: 0; padding-right: 0;">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8" style="color: black; font-family: Verdana,sans-serif;">
                                        <asp:TextBox runat="server" ID="txtEstimateNum" CssClass="form-control text" TabIndex="2"></asp:TextBox><%--onkeypress="return isNumber(event)"--%>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-4 control-label" style="padding-left: 0; padding-right: 0;">
                        ...
                        <div class="col-lg-7">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="background-color: #999; border: 1px solid #666; color: #fff!important; font: bold 14px/28px Arial, Helvetica, sans-serif; padding: 0 10px;">
                        ...
                        <div class="col-lg-5" style="padding-left: 0; padding-right: 0;">
                            <div class="form-horizontal" style="border: 1px solid lightgray; padding: 05px 10px 0 15px;">
                                <div class="form-group">
                                    <div class="col-lg-6" style="color: #000; font-family: Verdana, sans-serif; font-size: 13px; line-height: 18px; padding-right: 0;">
                                        Subtotal
                                    </div>
                            ...
                            <div class="form-horizontal" style="border: 1px solid lightgray; padding: 5px 10px 0 15px;">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6" style="text-align: right;">
                                        <asp:Label runat="server" ID="lblCurrencySymbol2" Text="₦" /><asp:Label runat="server" ID="lblEstimateTotal" Text="0.00"></asp:Label>
                                    </div>
                                </div>
                            ...
                            <div class="form-horizontal" style="background-color: lightblue; border: 1px solid lightgray; font-weight: bold; padding: 5px 10px 0 15px;">
                                <div class="form-group">
                                    <div class="col-lg-6" style="color: #000; font-family: Verdana, sans-serif; font-size: 15px; line-height: 18px; padding-right: 0;">
                                        Balance (<asp:Label runat="server" ID="lblCurrencyCode" Text="NGN"></asp:Label>)
                                    </div>
                                    <div class="col-lg-6" style="color: #000; font-family: Verdana, sans-serif; font-size: 14px; font-weight: bold; padding-left: 0; padding-right: 10px; text-align: right;">
                        ...
                        <ajaxToolkit:ModalPopupExtender runat="server" ID="mpEstimateTerms" PopupControlID="pnlEstimateTerms" TargetControlID="lnkSetTerms" CancelControlID="lnkClose" BackgroundCssClass="modelBackground">
                        </ajaxToolkit:ModalPopupExtender>
                        <asp:Panel ID="pnlEstimateTerms" runat="server" Width="750px" align="center" Style="background-color: white; border: 5px solid #CCCCCC; border-radius: 15px; display: none; padding: 22px 30px 25px; position: fixed; z-index: 100001;">
                            <div class="panel-body" style="border-color: #CCCCCC;">
                                <div class="control-label" style="color: black; font-size: 14px; padding-left: 20px; padding-right: 15px; text-align: left;">
                                    <h2 style="margin-top: 0;">Set Default Estimate Terms </h2>
                                    <p>
                                        The default terms you set here will be <span style="background-color: #ff9; text-transform: lowercase">re-used on future Estimates</span>.
                                    </p>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-lg-2 control-label" style="color: black; font-family: Verdana, sans-serif; font-size: 12px; padding: 0;">
                                                Default Terms
                                            </div>
                                            <div class="col-lg-9">
                ...
                <div style="margin-top: 15px; text-align: center;" id="savebtn" runat="server">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="example">
                            Save this estimate as a draft.	Your client will not be able to view this estimate until it is sent.
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="example" runat="server" id="saveMailDiv">
                            Email this estimate to your client.
                        </div>
                    </div>
                    <div class="col-lg-2">&nbsp;</div>
                </div>
                <div style="margin-top: 15px; text-align: center;" id="updatebtn" runat="server">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="example">
                            Save updates made to this estimate.
                        </div>
                    </div>
                    <div class="col-lg-4">
        ...
        <asp:Panel runat="server" ID="pnlView">
            ...
            <div id="printNone" style="">
                ...
                <div style="float: right; margin-bottom: 20px;">
                    <asp:Button runat="server" ID="btnAcceptView" Text="Accept" CssClass="btn-primary" Style="padding: 7px;" OnClick="btnAcceptView_Click" />
            ...
            <div runat="server" id="disputeDiv" visible="True">
                ...
                <div class="col-lg-8 rounded-container peel-shadows" style="padding-left: 0; padding-right: 0;">
                    <div class="form-horizontal" id="disputeDivLabel" runat="server" visible="False">
                        ...
                        <div class="col-lg-12 clearfix" style="text-align: center; margin-bottom: 10px; margin-top: 10px;">
                            <asp:Button runat="server" ID="btnDispute" Text="Respond to this request" CssClass="btn-default" Style="padding: 7px;" OnClick="btnDispute_OnClick" />
                        </div>
                    ...
                    <div class="form-horizontal cutline-top" id="disputeDivText" runat="server" visible="False">
                        <h3 style="padding-left: 15px; padding-right: 15px;">Response to Client</h3>
                        <div class="form-group">
                            <div class="col-lg-2" style="padding-right: 0; padding-left: 35px;">
                                <div class="staff-icon-medium bg-system-light"></div>
                            </div>
                            <div class="col-lg-10">
        ...
        <asp:Panel runat="server" ID="pnlViewAll">
            <div class="page-header" style="border-bottom: 5px solid #eee; display: inline-block; margin: 0; padding: 2%; width: 100%;">
                ...
                <asp:Button runat="server" ID="btnAdd" CssClass="btn btn-success" Text="New Estimate" OnClick="btnAdd_Click" Style="float: right;" />
            </div>
            <div class="panel-body" style="padding-left: 0; padding-right: 0;">
                <div class="col-lg-12" style="padding-left: 0; padding-right: 0;">
                        ...
                        <div class="col-lg-6">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <asp:TextBox runat="server" ID="txtEstimateNumberSearch" CssClass="searchText"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-5" style="text-align: right">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3" style="padding: 0">
                                        ...
                                        <ajaxToolkit:CalendarExtender runat="server" ID="ceDateFrom" TargetControlID="txtEstimateDateFrom" />
                                    </div>
                                    <div class="col-lg-1" style="padding: 0">to</div>
                                    <div class="col-lg-3" style="padding: 0">
                                        <asp:TextBox runat="server" ID="txtEstimateDateTo" CssClass="searchText"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender runat="server" ID="ceDateTo" TargetControlID="txtEstimateDateTo" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-5" style="text-align: right">
                    ...
                    <div style="background-color: lightgray; padding: 10px;">
                        ...
                        <asp:Button runat="server" ID="btnInvoice" CssClass="btn-primary" Text="Convert To Invoice" OnClick="btnInvoice_OnClick" />
                        <asp:Button runat="server" ID="btnAccept" CssClass="btn-primary" Text="Accept" OnClick="btnAccept_OnClick" />
                    ...
                    <asp:GridView runat="server" ID="gvEstimate" Width="100%" Font-Size="Small" AllowPaging="True" AutoGenerateColumns="False"
                        PageSize="50" CssClass="table table-striped table-hover" DataKeyNames="EstimateID"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Estimate" SortExpression="EstimateNumber">
                                <ItemTemplate>
                                    <a href='<%# "EstimateMaster.aspx?cmd=view&ID=" + Eval("EstimateID") %>'>
                                        <%# Eval("EstimateNumber") %>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblEstimateStatus" Visible='<%# Eval("EstimateStatus").ToString() != "invoiced" %>'>
                                        <a href='<%# "EstimateMaster.aspx?cmd=add&ID=" + Eval("EstimateID") %>'>edit</a>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <div style="background-color: white; border-bottom: 1px solid lightgray; text-align: right;">
                        <a id="activeTag" runat="server" href="EstimateMaster.aspx">active</a>
                        &nbsp; | &nbsp;
                        <a id="archivedTag" runat="server" href="EstimateMaster.aspx?ar=true&ac=false">archived</a>
                        &nbsp; | &nbsp;
                        <a id="deletedTag" runat="server" href="EstimateMaster.aspx?de=true&ac=false">deleted</a>
                        <div>&nbsp;</div>
                    </div>

                    <div class="totals ta_right">
                        <asp:GridView runat="server" ID="gvEstimateTotal" CssClass="gridTableView table table-responsive" AutoGenerateColumns="False" GridLines="None">
                            <Columns>
                        ...
                        <asp:SqlDataSource runat="server" ID="sqldsEstimateTotalCompany" ConnectionString='<%$ ConnectionStrings:IITS_CloudAccountConnectionString %>' SelectCommand="SELECT SUM(EstimateTotal) EstimateTotal,CurrencyCode FROM EstimateMaster i INNER JOIN CurrencyMaster c ON i.CurrencyID = c.CurrencyID WHERE [CompanyID] = @CompanyID AND [Active] = @Active AND [Archived] = @Archived AND [Deleted] = @Deleted GROUP BY CurrencyCode">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID" Type="Int32"></asp:ControlParameter>
                        ...
                        <asp:SqlDataSource runat="server" ID="sqldsEstimateTotalCompanyStaff" ConnectionString='<%$ ConnectionStrings:IITS_CloudAccountConnectionString %>' SelectCommand="SELECT SUM(EstimateTotal) EstimateTotal,CurrencyCode FROM EstimateMaster i INNER JOIN CurrencyMaster c ON i.CurrencyID = c.CurrencyID WHERE [CompanyID] = @CompanyID AND [ClientID] IN (SELECT ClientID FROM StaffClientAssignDetails WHERE StaffID = @StaffID AND IsAssign = 1) AND [Active] = @Active AND [Archived] = @Archived AND [Deleted] = @Deleted GROUP BY CurrencyCode">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID" Type="Int32"></asp:ControlParameter>
                    ...
                    <asp:ObjectDataSource runat="server" ID="objdsEstimate" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByEstimateSearch" TypeName="DABL.DAL.CloudAccountDATableAdapters.EstimateMasterTableAdapter">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID" Type="Int32"></asp:ControlParameter>
                            <asp:QueryStringParameter QueryStringField="ac" DefaultValue="true" Type="Boolean" Name="Active" />
                            <asp:QueryStringParameter QueryStringField="ar" DefaultValue="false" Type="Boolean" Name="Archived" />
                            <asp:QueryStringParameter QueryStringField="de" DefaultValue="false" Type="Boolean" Name="Deleted" />
                            <asp:ControlParameter ControlID="txtEstimateNumberSearch" PropertyName="Text" ConvertEmptyStringToNull="True" Name="EstimateNumber" Type="String"></asp:ControlParameter>
                    ...
                    <asp:ObjectDataSource runat="server" ID="objdsEstimateStaff" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByEstimateSearchForStaff" TypeName="DABL.DAL.CloudAccountDATableAdapters.EstimateMasterTableAdapter">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="hfCompanyID" PropertyName="Value" DefaultValue="0" Name="CompanyID" Type="Int32"></asp:ControlParameter>
                            <asp:ControlParameter ControlID="hfStaffID" PropertyName="Value" DefaultValue="0" Name="StaffID" Type="Int32"></asp:ControlParameter>
                            <asp:QueryStringParameter QueryStringField="ac" DefaultValue="true" Type="Boolean" Name="Active" />
