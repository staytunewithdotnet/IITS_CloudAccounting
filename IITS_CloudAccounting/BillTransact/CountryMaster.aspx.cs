...
namespace IITS_CloudAccounting.Admin
{
  public class CountryMaster : Page
  {
    ...
    {
      this.Response.Redirect("~/BillTransact/CountryMaster.aspx?cmd=view&ID=" + this.gvCountry.SelectedRow.Cells[0].Text);
      this.BindGrid();
    }
    ...
    {
      this.Response.Redirect("~/BillTransact/CountryMaster.aspx?cmd=add");
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
      ...
      if (this.txtCode.Text.Trim().Length > 0 && this.txtName.Text.Trim().Length > 0)
      {
        ...
        if (num != 0)
        {
          ...
          this.Response.Redirect("~/BillTransact/CountryMaster.aspx?cmd=view&ID=" + (object) num);
        }
        else
        ...
        if (this.Page.IsValid)
        {
          if (this.txtCode.Text.Trim().Length > 0 && this.txtName.Text.Trim().Length > 0)
          {
            ...
            if (this.objCountryMasterBll.UpdateCountry(int.Parse(this.hfCountry.Value.Trim()), this.txtCode.Text.Trim(), this.txtName.Text.Trim(), this.txtDesc.Text.Trim(), this.chkStatus.Checked))
            {
              ...
              this.Response.Redirect("~/BillTransact/CountryMaster.aspx?cmd=view&ID=" + this.Request.QueryString["ID"]);
            }
            else
    ...
    {
      this.Response.Redirect("~/BillTransact/CountryMaster.aspx?cmd=add&ID=" + this.Request.QueryString["ID"]);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
      ...
      else if (this.hfCountry.Value != null)
      {
        if (this.objCountryMasterBll.DeleteCountry(int.Parse(this.hfCountry.Value)))
        {
          ...
          this.Response.Redirect("~/BillTransact/CountryMaster.aspx");
        }
        else
