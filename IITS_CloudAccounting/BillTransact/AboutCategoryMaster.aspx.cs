...
namespace IITS_CloudAccounting.Admin
{
  public class AboutCategoryMaster : Page
  {
    ...
    {
      this.Response.Redirect("~/BillTransact/AboutCategoryMaster.aspx?cmd=view&ID=" + this.gvAboutCategory.SelectedRow.Cells[0].Text);
      this.BindGrid();
    }
    ...
    {
      this.Response.Redirect("~/BillTransact/AboutCategoryMaster.aspx?cmd=add");
    }
        ...
        if (this.Page.IsValid)
        {
          if (this.txtAboutCategoryName.Text.Trim().Length > 0)
          {
            if (this.objAboutCategoryMasterBll.UpdateAboutCategory(int.Parse(this.hfAboutCategory.Value.Trim()), this.txtAboutCategoryName.Text.Trim(), this.txtDesc.Text.Trim(), this.chkStatus.Checked))
            {
              ...
              this.Response.Redirect("~/BillTransact/AboutCategoryMaster.aspx?cmd=view&ID=" + this.Request.QueryString["ID"]);
            }
            else
    ...
    {
      this.Response.Redirect("~/BillTransact/AboutCategoryMaster.aspx?cmd=add&ID=" + this.Request.QueryString["ID"]);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
      if (this.hfAboutCategory.Value != null)
      {
        if (this.objAboutCategoryMasterBll.DeleteAboutCategory(int.Parse(this.hfAboutCategory.Value)))
        {
          ...
          this.Response.Redirect("~/BillTransact/AboutCategoryMaster.aspx");
        }
        else
