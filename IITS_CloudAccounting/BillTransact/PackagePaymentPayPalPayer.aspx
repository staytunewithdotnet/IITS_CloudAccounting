<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackagePaymentPayPalPayer.aspx.cs" Inherits="IITS_CloudAccounting.Admin.PackagePaymentPayPalPayer" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="PackagePaymentPayPalPayer.aspx">Secure Payment - PayPal
                                </a>
                            </li>
                        </ol>
                    </div>
        ...
        <asp:HiddenField runat="server" ID="hCloudPackageType" /> 
