    ...
    <div class="row" style="margin-top: -45px;">
        <div class="col-sm-12">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="NewCreditEmailTemplate.aspx">New Credit Email Template</a>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12" style="padding: 0;">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <asp:TextBox runat="server" ID="txtSubject" Text="New Credit ::CreditNum:: from ::companyName:: , sent using Bill Transact" Enabled="False"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-2 control-label">
                        ...
                        <div class="col-lg-10">
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a onclick="writeInTextBox('##creditNumber##')">Credit Number</a>
                                        <a onclick="writeInTextBox('##someLink##')">Credit Link</a>
