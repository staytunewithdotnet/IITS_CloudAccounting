<%@ Page Title="New Invoice Email Template" Language="C#" MasterPageFile="~/BillTransact/Doyingo.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="NewInvoiceEmailTemplate.aspx.cs" Inherits="IITS_CloudAccounting.Admin.NewInvoiceEmailTemplate" %>
    ...
    <div class="row" style="margin-top: -45px;">
        <div class="col-sm-12">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="NewInvoiceEmailTemplate.aspx">New Invoice Email Template</a>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12" style="padding: 0;">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <asp:TextBox runat="server" ID="txtSubject" Text="New invoice ::InvoiceNum:: from ::companyName:: , sent using Bill Transact" Enabled="False"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-2 control-label">
