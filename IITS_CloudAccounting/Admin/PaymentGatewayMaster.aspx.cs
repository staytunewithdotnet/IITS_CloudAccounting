...
{
  public class PaymentGatewayMaster : Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Admin.RoleName != null)
      {
        ...
        {
          PaymentGatewayMaster.AddStatus = "True";
          PaymentGatewayMaster.EditStatus = "True";
          PaymentGatewayMaster.ViewStatus = "True";
          PaymentGatewayMaster.DeleteStatus = "True";
        }
        else if (Admin.RoleName == "MasterAdmin")
        {
          ...
          {
            PaymentGatewayMaster.AddStatus = this.objMasterAdminRightsMasterDT.Rows[0]["AddMode"].ToString();
            PaymentGatewayMaster.EditStatus = this.objMasterAdminRightsMasterDT.Rows[0]["EditMode"].ToString();
            PaymentGatewayMaster.ViewStatus = this.objMasterAdminRightsMasterDT.Rows[0]["ViewMode"].ToString();
            PaymentGatewayMaster.DeleteStatus = this.objMasterAdminRightsMasterDT.Rows[0]["DeleteMode"].ToString();
          }
          else
          {
            PaymentGatewayMaster.AddStatus = "";
            PaymentGatewayMaster.EditStatus = "";
            PaymentGatewayMaster.ViewStatus = "";
            PaymentGatewayMaster.DeleteStatus = "";
          }
        }
        else if (Admin.RoleName == "Admin")
        {
          ...
          {
            PaymentGatewayMaster.AddStatus = this.objCompanyAdminRightsMasterDT.Rows[0]["AddMode"].ToString();
            PaymentGatewayMaster.EditStatus = this.objCompanyAdminRightsMasterDT.Rows[0]["EditMode"].ToString();
            PaymentGatewayMaster.ViewStatus = this.objCompanyAdminRightsMasterDT.Rows[0]["ViewMode"].ToString();
            PaymentGatewayMaster.DeleteStatus = this.objCompanyAdminRightsMasterDT.Rows[0]["DeleteMode"].ToString();
          }
          else
          {
            PaymentGatewayMaster.AddStatus = "";
      ...
      if (PaymentGatewayMaster.ViewStatus == "True")
      {
        if (this.Request.QueryString["cmd"] != null)
        {
          ...
          {
            case "view":
              if (this.Request.QueryString["ID"] == null || !(PaymentGatewayMaster.ViewStatus == "True"))
                break;
              ...
              this.ViewRecord(i);
              this.btnEdit.Visible = PaymentGatewayMaster.EditStatus == "True";
              this.btnAddPaymentGateway.Visible = this.btnAdd.Visible = PaymentGatewayMaster.AddStatus == "True";
              this.btnDelete.Visible = PaymentGatewayMaster.DeleteStatus == "True";
            ...
            case "add":
              ...
              {
                if (!(PaymentGatewayMaster.EditStatus == "True"))
                  break;
              ...
              if (!(PaymentGatewayMaster.AddStatus == "True"))
                break;
              this.Clear();
        ...
        else
        {
          ...
          this.pnlView.Visible = false;
          this.pnlAdd.Visible = false;
          if (PaymentGatewayMaster.AddStatus == "False")
            this.btnAddPaymentGateway.Visible = this.btnAdd.Visible = false;
          else
            this.btnAddPaymentGateway.Visible = this.btnAdd.Visible = true;
        }
      }
      else if (PaymentGatewayMaster.AddStatus == "True" && PaymentGatewayMaster.EditStatus == "False" && (PaymentGatewayMaster.ViewStatus == "False" && PaymentGatewayMaster.DeleteStatus == "False"))
      {
        this.pnlAdd.Visible = true;
        this.btnUpdate.Visible = false;
        this.btnCancel.Visible = false;
