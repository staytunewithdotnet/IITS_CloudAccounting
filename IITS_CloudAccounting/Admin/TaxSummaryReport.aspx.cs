...
// Type: IITS_CloudAccounting.Admin.TaxSummaryReport
...
{
  public class TaxSummaryReport : Page
  {
    ...
    protected GridView gvTaxSummary;
    protected ObjectDataSource objdsTaxSummary;
    ...
    {
      this.gvTaxSummary.DataBind();
      TaxSummaryReport.MergeRows(this.gvTaxSummary);
    }
